...
{
    public class CreateBankingDetailsWizard : IWizardProcess
    {
        private readonly IClaimService _claimService;
        private readonly IRolePlayerService _rolePlayerService;
        private readonly IClaimService _claimCareService;

        public CreateBankingDetailsWizard(
        ...
        public async Task<int> StartWizard(IWizardContext context)
        {
            ...
            const string newBeneficiary = "Create Banking Details";
            var bankingModel = CreateClaimBeneficiaryBankingModel();

            if (context.LinkedItemId > 0)
            {
                bankingModel.RolePlayer = await _rolePlayerService.GetRolePlayer(context.LinkedItemId);
            }
        ...
        public async Task SubmitWizard(IWizardContext context)
        {
            ...
            bankAccount.RolePlayerId = bankingModel.RolePlayer.RolePlayerId;
