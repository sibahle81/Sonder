...
{
    public class CADRequestInvoicePaymentWizard : IWizardProcess
    {
        private readonly IRolePlayerService _rolePlayerService;
        private readonly IPolicyService _policyService;
        private readonly IClaimInvoiceService _claimInvoiceService;

        public CADRequestInvoicePaymentWizard(
        ...
        public async Task<int> StartWizard(IWizardContext context)
        {
            ...
            var label = $"CAD request approval for invoice payment - {claimInvoice.ClaimInvoiceType.DisplayAttributeValue()} for amount {claimInvoice.InvoiceAmount} ({person.DisplayName})";

            claimInvoice.ClaimInvoiceStatusId = (int)InvoiceStatusEnum.RequestedForApproval;
            await _claimInvoiceService.UpdateClaimInvoice(claimInvoice);
