...
{
    public class DisabilityToFatalWizard : IWizardProcess
    {
        private readonly IRolePlayerService _rolePlayerService;
        private readonly IPolicyService _policyService;

        public DisabilityToFatalWizard(
        ...
        public async Task<int> StartWizard(IWizardContext context)
        {
            ...
            var label = !string.IsNullOrEmpty(personEvent.PersonEventReferenceNumber) ? $"D2F Initiated: ({personEvent.PersonEventReferenceNumber})" : "D2F Initiated";
