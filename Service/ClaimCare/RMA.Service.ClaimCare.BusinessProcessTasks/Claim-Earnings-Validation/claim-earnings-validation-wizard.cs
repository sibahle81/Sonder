...
{
    public class ClaimEarningsValidationWizard : IWizardProcess
    {
        private readonly IRolePlayerService _rolePlayerService;
        private readonly IPolicyService _policyService;

        public ClaimEarningsValidationWizard(
        ...
        public async Task<int> StartWizard(IWizardContext context)
        {
            ...
            var label = $"Claim Earnings Validate ({personEvent.PersonEventReferenceNumber}) {person.DisplayName}";
