...
{
    public class MedicalReportMismatchWizard : IWizardProcess
    {
        private readonly IRolePlayerService _rolePlayerService;
        private readonly IPolicyService _policyService;

        public MedicalReportMismatchWizard(
        ...
        public async Task<int> StartWizard(IWizardContext context)
        {
            ...
            var label = $"1st medical report not same as the 2nd medical report ({personEvent.PersonEventReferenceNumber}) {person.DisplayName}";
