...
{
    public class TTDNearing18MonthsWizard : IWizardProcess
    {
        private readonly IRolePlayerService _rolePlayerService;
        private readonly IPolicyService _policyService;

        public TTDNearing18MonthsWizard(
        ...
        public async Task<int> StartWizard(IWizardContext context)
        {
            ...
            var label = $"TTD 18 months ({personEvent.PersonEventReferenceNumber}) {person.DisplayName}";
