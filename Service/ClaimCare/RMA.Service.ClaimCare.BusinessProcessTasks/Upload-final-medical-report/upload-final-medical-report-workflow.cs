...
{
    public class UploadFinalMedicalReportCCAWizard : IWizardProcess
    {
        private readonly IRolePlayerService _rolePlayerService;
        private readonly IPolicyService _policyService;

        public UploadFinalMedicalReportCCAWizard(
        ...
        public async Task<int> StartWizard(IWizardContext context)
        {
            ...
            var label = $"Upload Final Medical Report - {personEvent.PersonEventReferenceNumber} ({person.DisplayName})";
