...
{
    public class ClaimAbove30percentpdScaWizard : IWizardProcess
    {
        private readonly IRolePlayerService _rolePlayerService;
        private readonly IPolicyService _policyService;

        public ClaimAbove30percentpdScaWizard(
        ...
        public async Task<int> StartWizard(IWizardContext context)
        {
            ...
            var label = $"Claim Above 30percentpd ({personEvent.PersonEventReferenceNumber}) {person.DisplayName}";
