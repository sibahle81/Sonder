...
{
    public class ReviewInjuryIcd10CodeWizard : IWizardProcess
    {
        ...
        public ReviewInjuryIcd10CodeWizard(
        ...
        public async Task<int> StartWizard(IWizardContext context)
        {
            ...
            var label = $"Review Injury ICD10 Code for PEV reference number: ({data.PersonEventReferenceNumber})";
        ...
        public async Task SubmitWizard(IWizardContext context)
        {
            ...
            await _claimService.NotifyPersonEventOwnerOrDefaultRole(personEvent.PersonEventId, "Review Injury ICD10 Code was completed", "Clinical Claims Adjudicator");
            ...
            await _commonSystemNoteService.CreateCommonSystemNote(new CommonSystemNote
            {
                ...
                Text = "Review Injury ICD10 Code was completed",
                IsActive = true
            });
        }
