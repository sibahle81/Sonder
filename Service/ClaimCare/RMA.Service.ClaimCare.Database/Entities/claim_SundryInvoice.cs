...
{
    public partial class claim_SundryInvoice : IAuditableEntity, ISoftDeleteEntity
    {
        ...
        /// <summary>
        /// Parent claim_ClaimInvoice pointed by [SundryInvoice].([ClaimInvoiceId]) (FK_Sundry_ClaimItem)
        /// </summary>
        public virtual claim_ClaimInvoice ClaimInvoice { get; set; } // FK_Sundry_ClaimItem

        /// <summary>
        /// Parent claim_PersonEvent pointed by [SundryInvoice].([PersonEventId]) (FK_SundryInvoice_PersonEvent)
        /// </summary>
        public virtual claim_PersonEvent PersonEvent { get; set; } // FK_SundryInvoice_PersonEvent

        public claim_SundryInvoice()
        {
            InitializePartial();
        }
