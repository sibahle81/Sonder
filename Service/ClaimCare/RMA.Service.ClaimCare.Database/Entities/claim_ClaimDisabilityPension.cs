...
{
    public partial class claim_ClaimDisabilityPension : IAuditableEntity, ISoftDeleteEntity
    {
        ...
        /// <summary>
        /// Parent claim_PersonEvent pointed by [ClaimDisabilityPension].([PersonEventId]) (FK_ClaimDisabilityPension_PersonEvent)
        /// </summary>
        public virtual claim_PersonEvent PersonEvent { get; set; } // FK_ClaimDisabilityPension_PersonEvent

        public claim_ClaimDisabilityPension()
        {
            InitializePartial();
        }
