...
{
    public class cost_NoteConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<cost_Note>
    {
        public cost_NoteConfiguration()
            : this("cost")
        {
        }

        public cost_NoteConfiguration(string schema)
        {
            ToTable("Note", schema);
            HasKey(x => x.Id);
