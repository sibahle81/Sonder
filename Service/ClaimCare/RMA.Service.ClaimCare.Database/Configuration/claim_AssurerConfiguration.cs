...
{
    public class claim_AssurerConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<claim_Assurer>
    {
        public claim_AssurerConfiguration()
            : this("claim")
        {
        }

        public claim_AssurerConfiguration(string schema)
        {
            ToTable("Assurer", schema);
            HasKey(x => x.AssurerId);

            Property(x => x.AssurerId).HasColumnName(@"AssurerID").HasColumnType("int").IsRequired().HasDatabaseGeneratedOption(System.ComponentModel.DataAnnotations.Schema.DatabaseGeneratedOption.Identity);
