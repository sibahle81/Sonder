...
{
    public class claim_PersonEventNoteConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<claim_PersonEventNote>
    {
        public claim_PersonEventNoteConfiguration()
            : this("claim")
        {
        }

        public claim_PersonEventNoteConfiguration(string schema)
        {
            ToTable("PersonEventNote", schema);
            HasKey(x => x.Id);
