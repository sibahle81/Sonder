...
{
    public class cost_LastViewedConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<cost_LastViewed>
    {
        public cost_LastViewedConfiguration()
            : this("cost")
        {
        }

        public cost_LastViewedConfiguration(string schema)
        {
