...
{
    public class claim_SundryInvoiceConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<claim_SundryInvoice>
    {
        public claim_SundryInvoiceConfiguration()
            : this("claim")
        {
        }

        public claim_SundryInvoiceConfiguration(string schema)
        {
            ToTable("SundryInvoice", schema);
            ...
            Property(x => x.ReferenceNumber).HasColumnName(@"ReferenceNumber").HasColumnType("varchar").IsOptional().IsUnicode(false).HasMaxLength(100);
            ...
            // Foreign keys
            HasRequired(a => a.ClaimInvoice).WithOptional(b => b.SundryInvoice).WillCascadeOnDelete(false); // FK_Sundry_ClaimItem
            HasRequired(a => a.PersonEvent).WithMany(b => b.SundryInvoices).HasForeignKey(c => c.PersonEventId).WillCascadeOnDelete(false); // FK_SundryInvoice_PersonEvent
        }
    }
