...
{
    public class claim_AuditLogConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<claim_AuditLog>
    {
        public claim_AuditLogConfiguration()
            : this("claim")
        {
        }

        public claim_AuditLogConfiguration(string schema)
        {
