...
{
    public class claim_WidowLumpSumInvoiceConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<claim_WidowLumpSumInvoice>
    {
        public claim_WidowLumpSumInvoiceConfiguration()
            : this("claim")
        {
        }

        public claim_WidowLumpSumInvoiceConfiguration(string schema)
        {
            ToTable("WidowLumpSumInvoice", schema);
            ...
            // Foreign keys
            HasRequired(a => a.Claim).WithMany(b => b.WidowLumpSumInvoices).HasForeignKey(c => c.ClaimId).WillCascadeOnDelete(false); // FK_WidowLumpSumInvoice_Claim
            HasRequired(a => a.ClaimInvoice).WithOptional(b => b.WidowLumpSumInvoice).WillCascadeOnDelete(false); // FK_WidowLumpSumInvoice_ClaimInvoice
        }
    }
