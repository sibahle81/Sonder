...
{
    public class cost_AuditLogConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<cost_AuditLog>
    {
        public cost_AuditLogConfiguration()
            : this("cost")
        {
        }

        public cost_AuditLogConfiguration(string schema)
        {
