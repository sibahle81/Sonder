...
{
    public class claim_NoteConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<claim_Note>
    {
        public claim_NoteConfiguration()
            : this("claim")
        {
        }

        public claim_NoteConfiguration(string schema)
        {
            ToTable("Note", schema);
            HasKey(x => x.Id);
