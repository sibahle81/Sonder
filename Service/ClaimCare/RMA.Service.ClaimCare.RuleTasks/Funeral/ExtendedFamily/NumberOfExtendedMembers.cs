...
namespace RMA.Service.ClaimCare.RuleTasks.Funeral.ExtendedFamily
{
    public class NumberOfExtendedMembers : IRule
    {
        public const string RuleName = "Number of Extended Members";
        public string Name { get; } = RuleName;
        public string Code { get; } = "NUMEXT";
        ...
        public RuleResult Execute(IRuleContext context)
        {
            try
            {
                ...
                return ValidateInput(ruleData, metaData.FirstOrDefault());
            }
