...
namespace RMA.Service.ClaimCare.RuleTasks.Funeral.GroupFuneralAge
{
    public class GroupFuneralAgeRule : IRule
    {
        public const string RuleName = "Fatal Group Scheme Age";
