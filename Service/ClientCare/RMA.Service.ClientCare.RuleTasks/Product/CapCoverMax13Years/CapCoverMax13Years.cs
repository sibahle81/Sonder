...
namespace RMA.Service.ClientCare.RuleTasks.Product.CapCoverMax13Years
{
    public class CapCoverMax13Years : CapCoverBase, IRule
    {
        public const string RuleName = "Cap Cover per Age Group (> 5 and = 13)";

        public override string Name { get; } = RuleName;
        public string Code { get; } = "PROD03";
