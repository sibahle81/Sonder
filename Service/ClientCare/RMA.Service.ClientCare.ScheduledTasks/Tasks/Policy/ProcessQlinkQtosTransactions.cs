...
{
    public class ProcessQlinkQtosTransactions : IScheduledTaskHandler
    {
        private readonly IQLinkService _qlinkService;

        public ProcessQlinkQtosTransactions(IQLinkService qlinkService)
        {
        ...
        {
            await _qlinkService.ProcessQlinkQtosTransactionAsync();
            return true;
        }
