...
{
    public class ProcessQlinkReservations : IScheduledTaskHandler
    {
        private readonly IQLinkService _qlinkService;

        public ProcessQlinkReservations(IQLinkService qlinkService)
        {
        ...
        {
            await _qlinkService.ActivateQlinkReservationsAsync();
            return true;
        }
