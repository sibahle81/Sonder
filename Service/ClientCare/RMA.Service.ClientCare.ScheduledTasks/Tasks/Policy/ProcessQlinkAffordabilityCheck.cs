...
{
    public class ProcessQlinkAffordabilityCheck : IScheduledTaskHandler
    {
        private readonly IQLinkService _qlinkService;

        public ProcessQlinkAffordabilityCheck(IQLinkService qlinkService)
        {
        ...
        {
            await _qlinkService.ProcessQlinkFailedAffordabilityCheckPolicyNumbersAsync();
            return true;
        }
