...
{
    public class ActivateFreePolicies : IScheduledTaskHandler
    {
        private readonly IPolicyService _policyService;

        public ActivateFreePolicies(IPolicyService policyService)
        {
        ...
        {
            var results = await _policyService.ActivateFreePolicies();
            return results >= 0;
        }
    }
}
