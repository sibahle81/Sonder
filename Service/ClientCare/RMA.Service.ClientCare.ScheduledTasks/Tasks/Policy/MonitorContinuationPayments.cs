...
{
    public class MonitorContinuationPayments : IScheduledTaskHandler
    {
        private readonly IRolePlayerPolicyService rolePlayerService;
        public MonitorContinuationPayments(IRolePlayerPolicyService service)
        {
        ...
        {
            var results = await rolePlayerService.MonitorContinuationPayments();
            return true;
        }
    }
}
