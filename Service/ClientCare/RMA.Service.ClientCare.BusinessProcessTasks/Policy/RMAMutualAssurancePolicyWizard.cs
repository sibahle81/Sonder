...
{
    public class RMAMutualAssurancePolicyWizard : IWizardProcess
    {
        ...
        public RMAMutualAssurancePolicyWizard(
        ...
        public async Task<int> StartWizard(IWizardContext context)
        {
            ...
            foreach (var quoteDetail in quote.QuoteDetailsV2)
            {
                ...
                if (index <= -1)
                {
                    ...
                    var preffix = productOption != null ? productOption.Code : "03";
        ...
        {
            if (member.MemberStatus == MemberStatusEnum.ActiveWithoutPolicies || member.MemberStatus == MemberStatusEnum.Inactive)
            {
