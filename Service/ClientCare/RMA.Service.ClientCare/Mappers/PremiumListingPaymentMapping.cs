...
{
    public class PremiumListingPaymentMapping : CsvMapping<Load_PremiumListingPayment>
    {
        public PremiumListingPaymentMapping()
        {
            this.MapProperty(0, s => s.Company);
            this.MapProperty(1, s => s.GroupPolicyNumber);
            this.MapProperty(2, s => s.MemberPolicyNumber);
