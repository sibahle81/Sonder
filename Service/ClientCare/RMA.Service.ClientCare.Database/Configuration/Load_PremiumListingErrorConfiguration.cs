...
{
    public class Load_PremiumListingErrorConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<Load_PremiumListingError>
    {
        public Load_PremiumListingErrorConfiguration()
            : this("Load")
        {
        }

        public Load_PremiumListingErrorConfiguration(string schema)
        {
