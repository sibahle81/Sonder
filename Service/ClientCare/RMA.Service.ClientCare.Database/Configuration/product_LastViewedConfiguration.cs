...
{
    public class product_LastViewedConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<product_LastViewed>
    {
        public product_LastViewedConfiguration()
            : this("product")
        {
        }

        public product_LastViewedConfiguration(string schema)
        {
