...
{
    public class Load_ConsolidatedFuneralMemberConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<Load_ConsolidatedFuneralMember>
    {
        public Load_ConsolidatedFuneralMemberConfiguration()
            : this("Load")
        {
        }

        public Load_ConsolidatedFuneralMemberConfiguration(string schema)
        {
            ToTable("ConsolidatedFuneralMember", schema);
            HasKey(x => x.Id);
