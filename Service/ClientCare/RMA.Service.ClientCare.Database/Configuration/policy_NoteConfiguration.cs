...
{
    public class policy_NoteConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<policy_Note>
    {
        public policy_NoteConfiguration()
            : this("policy")
        {
        }

        public policy_NoteConfiguration(string schema)
        {
            ToTable("Note", schema);
            HasKey(x => x.Id);
