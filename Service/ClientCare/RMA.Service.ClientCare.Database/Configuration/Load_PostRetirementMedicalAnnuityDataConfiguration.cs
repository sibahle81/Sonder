...
{
    public class Load_PostRetirementMedicalAnnuityDataConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<Load_PostRetirementMedicalAnnuityData>
    {
        public Load_PostRetirementMedicalAnnuityDataConfiguration()
            : this("Load")
        {
        }

        public Load_PostRetirementMedicalAnnuityDataConfiguration(string schema)
        {
            ToTable("PostRetirementMedicalAnnuityData", schema);
