...
{
    public class client_AuditLogConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<client_AuditLog>
    {
        public client_AuditLogConfiguration()
            : this("client")
        {
        }

        public client_AuditLogConfiguration(string schema)
        {
