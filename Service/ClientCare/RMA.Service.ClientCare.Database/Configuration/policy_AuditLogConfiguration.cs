...
{
    public class policy_AuditLogConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<policy_AuditLog>
    {
        public policy_AuditLogConfiguration()
            : this("policy")
        {
        }

        public policy_AuditLogConfiguration(string schema)
        {
