...
{
    public class Load_InsuredLivesErrorConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<Load_InsuredLivesError>
    {
        public Load_InsuredLivesErrorConfiguration()
            : this("Load")
        {
        }

        public Load_InsuredLivesErrorConfiguration(string schema)
        {
            ToTable("InsuredLivesError", schema);
            HasKey(x => x.Id);
