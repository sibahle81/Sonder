...
{
    public class Load_StagePostRetirementMedicalAidConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<Load_StagePostRetirementMedicalAid>
    {
        public Load_StagePostRetirementMedicalAidConfiguration()
            : this("Load")
        {
        }

        public Load_StagePostRetirementMedicalAidConfiguration(string schema)
        {
            ToTable("StagePostRetirementMedicalAid", schema);
            HasKey(x => x.PostRetirementMedicalAidId);

            Property(x => x.PostRetirementMedicalAidId).HasColumnName(@"PostRetirementMedicalAidId").HasColumnType("int").IsRequired().HasDatabaseGeneratedOption(System.ComponentModel.DataAnnotations.Schema.DatabaseGeneratedOption.Identity);
            ...
            Property(x => x.FileIdentifierId).HasColumnName(@"FileIdentifierId").HasColumnType("uniqueidentifier").IsOptional();
