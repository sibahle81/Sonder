...
{
    public partial class lead_Address : IAuditableEntity, ISoftDeleteEntity
    {
        ...
        /// <summary>
        /// Parent lead_Lead pointed by [Address].([LeadId]) (FK_Lead_Address_LeadId)
        /// </summary>
        public virtual lead_Lead Lead { get; set; } // FK_Lead_Address_LeadId
