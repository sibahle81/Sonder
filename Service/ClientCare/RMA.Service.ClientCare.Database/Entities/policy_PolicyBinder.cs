...
namespace RMA.Service.ClientCare.Database.Entities
{
    public partial class policy_PolicyBinder : IAuditableEntity, ISoftDeleteEntity
    {
        ...
        /// <summary>
        /// Parent broker_Brokerage pointed by [PolicyBinder].([BinderId]) (Brokerage_PolicyBinder)
        /// </summary>
        public virtual broker_Brokerage Brokerage { get; set; } // Brokerage_PolicyBinder

        /// <summary>
        /// Parent broker_BrokerageContact pointed by [PolicyBinder].([BinderContactId]) (BrokerageContact_PolicyBinder)
        /// </summary>
        public virtual broker_BrokerageContact BrokerageContact { get; set; } // BrokerageContact_PolicyBinder
