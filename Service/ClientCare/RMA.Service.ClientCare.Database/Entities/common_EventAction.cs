...
{
    public partial class common_EventAction : ILazyLoadSafeEntity, IEntityStatus
    {
        public int EventActionId { get; set; } // EventActionID (Primary key)
