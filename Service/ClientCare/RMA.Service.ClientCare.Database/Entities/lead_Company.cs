...
{
    public partial class lead_Company : IAuditableEntity, ISoftDeleteEntity
    {
        ...
        /// <summary>
        /// Parent lead_Lead pointed by [Company].([LeadId]) (FK_Lead_Company_LeadId)
        /// </summary>
        public virtual lead_Lead Lead { get; set; } // FK_Lead_Company_LeadId
