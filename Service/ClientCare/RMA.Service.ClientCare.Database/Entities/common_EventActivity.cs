...
{
    public partial class common_EventActivity : ILazyLoadSafeEntity, IEntityStatus
    {
        public int EventActivityId { get; set; } // EventActivityID (Primary key)
