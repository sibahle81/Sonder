...
{
    public partial class broker_BrokerageBankAccount : IAuditableEntity, ISoftDeleteEntity
    {
        ...
        /// <summary>
        /// Parent broker_Brokerage pointed by [BrokerageBankAccount].([BrokerageId]) (FK_BrokerageBankAccount_Brokerage)
        /// </summary>
        public virtual broker_Brokerage Brokerage { get; set; } // FK_BrokerageBankAccount_Brokerage

        public broker_BrokerageBankAccount()
        {
            InitializePartial();
        }
