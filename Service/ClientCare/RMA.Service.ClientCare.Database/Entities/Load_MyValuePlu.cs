...
{
    public partial class Load_MyValuePlu : ILazyLoadSafeEntity
    {
        ...
        public string LifeCoverAmount { get; set; } // LifeCoverAmount (length: 64)
        public string FuneralCoverAmount { get; set; } // FuneralCoverAmount (length: 64)
        public string LifePremium { get; set; } // LifePremium (length: 64)
        public string FuneralPremium { get; set; } // FuneralPremium (length: 64)
        public string TotalPremium { get; set; } // TotalPremium (length: 64)
        ...
        public string PaymentMethod { get; set; } // PaymentMethod (length: 128)
