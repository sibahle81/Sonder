...
namespace RMA.Service.MediCare.RuleTasks.ClaimValidationRules.ClaimOutstandingRequirements
{
    public class ClaimOutstandingRequirementsRule : IRule
    {
        public const string RuleName = Constants.OutstandingRequirementsRuleName;
        ...
        private RuleResult CreateResult(string ruleData)
        {
            ...
            {
                RuleName = RuleName,
                Passed = ruleData == Constants.OutstandingRequirements,
        ...
        {
            if (!result.Passed)
                result.MessageList.Add(Constants.OutstandingRequirementsRuleValidation);
        }
    }
}
