...
{
    public class ReferenceNumberExistRule : IRule
    {
        public const string RuleName = Constants.ClaimReferenceNumberCheckRuleName;
        public string Name { get; } = RuleName;
        public string Code { get; } = "MI09";
        ...
        private RuleResult CreateResult(RuleData ruleData)
        {
            ...
            {
                RuleName = Constants.ClaimReferenceNumberExistValidation,
                Passed = !string.IsNullOrEmpty(ruleData.ClaimReferenceNumber),
        ...
        {
            if (!result.Passed)
                result.MessageList.Add(Constants.ClaimReferenceNumberExistValidation);
        }
    }
}
