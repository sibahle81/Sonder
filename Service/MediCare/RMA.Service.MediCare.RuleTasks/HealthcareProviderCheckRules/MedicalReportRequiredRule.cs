...
{
    public class MedicalReportRequiredRule : IRule
    {
        public const string RuleName = Constants.MedialReportRequiredRuleName;
        public string Name { get; } = RuleName;
        public string Code { get; } = "MI27";
        ...
        private RuleResult CreateResult(RuleData ruleData)
        {
            ...
            {
                RuleName = Constants.MedialReportRequiredRuleName,
                Passed = (ruleData.IsMedicalReportRequired && !ruleData.IsMedicalReportExist) ? false : true,
        ...
        {
            if (!result.Passed)
                result.MessageList.Add(Constants.HealthcareProviderMedialReportRequiredValidation);
        }
    }
}
