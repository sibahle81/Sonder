...
{
    public class PreAuthFromDateRule : IRule
    {
        public const string RuleName = Constants.PreAuthFromDateRuleName;
        public string Name { get; } = RuleName;
        public string Code { get; } = "PAC04";
        ...
        private RuleResult CreateResult(RuleData ruleData)
        {
            ...
            {
                RuleName = Constants.PreAuthFromDateRuleName,
                Passed = (ruleData.EventDate.Value.Date <= ruleData.DateAuthorisedFrom.Value.Date),
        ...
        {
            if (!result.Passed)
                result.MessageList.Add(Constants.PreAuthFromDateValidation);
        }
