...
namespace RMA.Service.MediCare.RuleTasks.PreAuthRules.DuplicatePreAuth
{
    public class DuplicatePreAuthRule : IRule
    {
        public const string RuleName = Constants.DuplicatePreAuthRuleName;
        public string Name { get; } = RuleName;
        public string Code { get; } = "PAC12";
        ...
        public RuleResult Execute(IRuleContext context)
        {
            try
            {
                ...
                if (ruleData != null)
                {
                    return CreateResult(ruleData.DuplicatePreAuthExist);
                }
        ...
        {
            if (!result.Passed)
                result.MessageList.Add(Constants.DuplicatePreAuthRuleValidation);
        }
