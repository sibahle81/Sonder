...
{
    public class ProhibitedPractitionerTypeRule : IRule
    {
        public const string RuleName = Constants.ProhibitedPractitionerTypeRuleName;
        ...
        public RuleResult Execute(IRuleContext context)
        {
            try
            {
                ...
                if (ruleData != null)
                {
                    return CreateResult(ruleData.IsProhibitedPractitionerType);
                }
        ...
        {
            if (!result.Passed)
                result.MessageList.Add(Constants.ProhibitedPractitionerTypeValidation);
        }
