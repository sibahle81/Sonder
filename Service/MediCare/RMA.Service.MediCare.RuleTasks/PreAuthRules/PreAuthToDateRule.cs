...
{
    public class PreAuthToDateRule : IRule
    {
        public const string RuleName = Constants.PreAuthToDateRuleName;
        public string Name { get; } = RuleName;
        public string Code { get; } = "PAC06";
        ...
        private RuleResult CreateResult(RuleData ruleData)
        {
            ...
            {
                RuleName = Constants.PreAuthToDateRuleName,
                Passed = true,
        ...
        {
            if (!result.Passed)
                result.MessageList.Add(Constants.PreAuthToDateValidation);
        }
