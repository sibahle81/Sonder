...
{
    public class DuplicateInvoiceRule : IRule
    {
        public const string RuleName = Constants.DuplicateInvoiceRuleName;
        ...
        public RuleResult Execute(IRuleContext context)
        {
            try
            {
                ...
                if (ruleData != null)
                {
                    return CreateResult(ruleData.DuplicateInvoiceExist);
                }
                else
                    return CreateNoDataRuleResult();
            }
