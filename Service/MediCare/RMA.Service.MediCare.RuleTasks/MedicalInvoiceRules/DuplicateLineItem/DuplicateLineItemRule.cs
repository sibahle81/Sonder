...
namespace RMA.Service.MediCare.RuleTasks.MedicalInvoiceRules.DuplicateLineItem
{
    public class DuplicateLineItemRule : IRule
    {
        public const string RuleName = Constants.DuplicateLineItemValidationRuleName;
        public string Name { get; } = RuleName;
        public string Code { get; } = "MI11";
        ...
        public RuleResult Execute(IRuleContext context)
        {
            try
            {
                ...
                if (ruleData != null)
                {
                    return CreateResult(ruleData.DuplicateLineItemExists);
                }
        ...
        {
            if (!result.Passed)
                result.MessageList.Add(Constants.DuplicateInvoiceRuleValidation);
        }
    }
}
