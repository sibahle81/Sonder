...
namespace RMA.Service.MediCare.RuleTasks.MedicalInvoiceRules.PreAuthExistCheck
{
    public class PreAuthExistCheckRule : IRule
    {
        public const string RuleName = Constants.PreAuthExistCheckRuleName;
        public string Name { get; } = RuleName;
        public string Code { get; } = "MI32";
        ...
        private RuleResult CreateResult(RuleData ruleData)
        {
            ...
            {
                RuleName = Constants.PreAuthExistCheckRuleName,
                Passed = ruleData.PreAuthExist,
        ...
        {
            if (!result.Passed)
                result.MessageList.Add(Constants.PreAuthExistCheckValidation);
        }
    }
}
