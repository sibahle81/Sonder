...
namespace RMA.Service.MediCare.RuleTasks.MedicalInvoiceRules.TotalAssessedAmount
{
    public class TotalAssessedAmountRule : IRule
    {
        public const string RuleName = Constants.AssessedAmountExclCheckRule;
        public string Name { get; } = RuleName;
        public string Code { get; } = "MI12";
        ...
        private RuleResult CreateResult(RuleData ruleData)
        {
            ...
            {
                RuleName = RuleName,
                Passed = ruleData.TotalInvoiceAssessedAmount > 0,
        ...
        {
            if (!result.Passed)
                result.MessageList.Add(Constants.AssessedAmountExclValidation);
        }
    }
}
