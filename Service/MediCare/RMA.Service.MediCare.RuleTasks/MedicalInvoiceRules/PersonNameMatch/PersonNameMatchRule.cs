...
{
    public class PersonNameMatchRule : IRule
    {
        public const string RuleName = Constants.MedicalInvoicePersonNameRuleName;
        public string Name { get; } = RuleName;
        public string Code { get; } = "MI21";
        ...
        private RuleResult CreateResult(RuleData ruleData)
        {
            ...
            {
                RuleName = Constants.MedicalInvoicePersonNameRuleName,
                Passed = string.Equals(ruleData.PersonNameOnClaim, ruleData.PersonNameOnInvoice,
                   StringComparison.OrdinalIgnoreCase) || (string.Equals(ruleData.InitialOnClaim, ruleData.InitialOnInvoice,
                   StringComparison.OrdinalIgnoreCase) && string.Equals(ruleData.SurnameOnClaim, ruleData.SurnameOnInvoice,
        ...
        {
            if (!result.Passed)
                result.MessageList.Add(Constants.PersonNameMatchValidation);
        }
    }
}
