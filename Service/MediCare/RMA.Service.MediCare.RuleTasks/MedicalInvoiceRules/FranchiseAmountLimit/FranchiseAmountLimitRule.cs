...
{
    public class FranchiseAmountLimitRule : IRule
    {
        public const string RuleName = Constants.InvoiceAmountLessThanFranchiseAmountRuleName;
        public string Name { get; } = RuleName;
        public string Code { get; } = "MI33";
        ...
        public RuleResult Execute(IRuleContext context)
        {
            try
            {
                ...
                if (ruleData != null)
                {
                    return CreateResult(ruleData.InvoiceAmountIsLessThanFranchiseAmount);
                }
        ...
        {
            if (!result.Passed)
                result.MessageList.Add(Constants.InvoiceAmountLessThanFranchiseAmountValidation);
        }
    }
}
