...
namespace RMA.Service.MediCare.RuleTasks.MedicalInvoiceRules.InvoiceIsActive
{
    public class InvoiceIsActiveRule : IRule
    {
        public const string RuleName = Constants.InvoiceIsActiveRule;
        public string Name { get; } = RuleName;
        public string Code { get; } = "MI24";
        ...
        public RuleResult Execute(IRuleContext context)
        {
            ...
            if (ruleData != null)
            {
                return CreateResult(ruleData.InvoiceIsActive);
            }
        ...
        {
            if (!result.Passed)
                result.MessageList.Add(Constants.InvoiceIsActiveValidation);
        }
    }
}
