...
{
    public class NoInvoiceLinesRule : IRule
    {
        public const string RuleName = Constants.NoInvoiceLinesRuleValidRuleName;
        public string Name { get; } = RuleName;
        public string Code { get; } = "MI28";
        ...
        public RuleResult Execute(IRuleContext context)
        {
            try
            {
                ...
                if (ruleData != null)
                {
                    return CreateResult(ruleData.InvoiceLinesTotal);
                }
        ...
        private RuleResult CreateResult(int ruleData)
        {
        ...
        {
            if (!result.Passed)
                result.MessageList.Add(Constants.NoInvoiceLinesValidation);
        }
    }
}