...
namespace RMA.Service.MediCare.RuleTasks.MedicalInvoiceRules.ICD10CodePractitionerTypeMapping
{
    public class ICD10CodePractitionerTypeMappingRule : IRule
    {
        public const string RuleName = Constants.ICD10CodePractitionerTypeMappingRuleName;
        public string Name { get; } = RuleName;
        public string Code { get; } = "MI19";
        ...
        private RuleResult CreateResult(RuleData ruleData)
        {
            ...
            {
                RuleName = RuleName,
                Passed = ruleData.ICD10CodePractitionerTypeMappingFound,
        ...
        {
            if (!result.Passed)
                result.MessageList.Add(Constants.ICD10CodePractitionerTypeMapping);
        }
    }
}
