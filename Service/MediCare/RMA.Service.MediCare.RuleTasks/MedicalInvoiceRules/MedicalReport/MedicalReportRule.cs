...
namespace RMA.Service.MediCare.RuleTasks.MedicalInvoiceRules.MedicalReport
{
    public class MedicalReportRule : IRule
    {
        public const string RuleName = Constants.MedicalReportRuleName;
        public string Name { get; } = RuleName;
        public string Code { get; } = "MI25";
        ...
        public RuleResult Execute(IRuleContext context)
        {
            try
            {
                ...
                if (ruleData != null)
                {
                    return CreateResult(ruleData.MedicalReportExist);
                }
        ...
        {
            if (!result.Passed)
                result.MessageList.Add(Constants.MedicalReportRuleValidation);
        }
    }
}
