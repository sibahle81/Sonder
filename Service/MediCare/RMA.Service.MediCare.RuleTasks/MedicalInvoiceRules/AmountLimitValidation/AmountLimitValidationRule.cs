...
namespace RMA.Service.MediCare.RuleTasks.MedicalInvoiceRules.AmountLimitValidation
{
    public class AmountLimitValidationRule : IRule
    {
        public const string RuleName = Constants.AmountLimitValidationRuleName;
        public string Name { get; } = RuleName;
        public string Code { get; } = "MI26";
        ...
        private RuleResult CreateResult(RuleData ruleData)
        {
            ...
            {
                RuleName = Constants.AmountLimitValidationRuleName,
                Passed = ruleData.InvoiceAmount <= ruleData.TotalAmountLimit,
        ...
        {
            if (!result.Passed)
                result.MessageList.Add(Constants.AmountLimitValidation);
        }
    }
}
