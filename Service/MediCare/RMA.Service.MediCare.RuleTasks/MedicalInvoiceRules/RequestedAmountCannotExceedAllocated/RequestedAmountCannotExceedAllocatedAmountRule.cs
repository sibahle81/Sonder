...
{
    public class RequestedAmountCannotExceedAllocatedAmountRule : IRule
    {
        public const string RuleName = Constants.RequestedAmountExceedsAllocatedAmountRule;
        public string Name { get; } = RuleName;
        public string Code { get; } = "MI22";
        ...
        private RuleResult CreateResult(RuleData ruleData)
        {
            ...
            {
                RuleName = Constants.RequestedAmountExceedsAllocatedAmountRule,
                Passed = (ruleData.TotalRequestedAmount <= ruleData.TotalAssessedAmountWithTolerance),
        ...
        {
            if (!result.Passed)
                result.MessageList.Add(Constants.RequestedAmountExceedsAllocatedAmountRuleValidation);
        }
    }
}