...
namespace RMA.Service.MediCare.RuleTasks.MedicalInvoiceRules.IDPassportMatch
{
    public class IDPassportMatchRule : IRule
    {
        public const string RuleName = Constants.MedicalInvoiceIDPassportRuleName;
        public string Name { get; } = RuleName;
        public string Code { get; } = "MI20";
        ...
        private RuleResult CreateResult(RuleData ruleData)
        {
            ...
            {
                RuleName = Constants.MedicalInvoiceIDPassportRuleName,
                Passed = ruleData.IDOrPassportNumberOnClaim == ruleData.IDOrPassportNumberOnInvoice,
        ...
        {
            if (!result.Passed)
                result.MessageList.Add(Constants.IDPassportMatchValidation);
        }
    }
}
