...
{
    public class ModifierMaxilloPracticeRule : IRule
    {
        public const string RuleName = Constants.ModifierMaxilloRuleName;
        public string Name { get; } = RuleName;
        public string Code { get; } = "MI39";
        ...
        public RuleResult Execute(IRuleContext context)
        {
            try
            {
                ...
                if (ruleData != null)
                {
                    return CreateResult(ruleData.IsMaxilloLineModifier);
                }
        ...
        {
            if (!result.Passed)
                result.MessageList.Add(Constants.ModifierMaxilloValidation);
        }
    }
}
