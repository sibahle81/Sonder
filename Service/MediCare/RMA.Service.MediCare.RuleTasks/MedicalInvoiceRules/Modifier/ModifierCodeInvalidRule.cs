...
{
    public class ModifierCodeInvalidRule : IRule
    {
        public const string RuleName = Constants.ModifierCodeInvalidRuleName;
        public string Name { get; } = RuleName;
        public string Code { get; } = "MI37";
        ...
        public RuleResult Execute(IRuleContext context)
        {
            try
            {
                ...
                if (ruleData != null)
                {
                    return CreateResult(ruleData.IsModifier);
                }
        ...
        {
            if (!result.Passed)
                result.MessageList.Add(Constants.ModifierCodeInvalidValidation);
        }
    }
}
