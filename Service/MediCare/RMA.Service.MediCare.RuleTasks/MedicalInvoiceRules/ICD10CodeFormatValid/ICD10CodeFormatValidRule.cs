...
using System.Linq;
namespace RMA.Service.MediCare.RuleTasks.MedicalInvoiceRules.ICD10CodeFormatValid
{
    public class ICD10CodeFormatValidRule : IRule
    {
        public const string RuleName = Constants.ICD10CodeFormatValidRuleName;
        ...
        public RuleResult Execute(IRuleContext context)
        {
            try
            {
                ...
                if (ruleData != null)
                {
                    return CreateResult(ruleData.ICD10CodeFormatValid);
                }
        ...
        {
            if (!result.Passed)
                result.MessageList.Add(Constants.ICD10CodeFormatRuleIsValideValidation);
        }
    }
}