...
namespace RMA.Service.MediCare.RuleTasks.MedicalInvoiceRules.InvoiceLineAmountGreaterThanZero
{
    public class InvoiceLineAmountGreaterThanZeroRule : IRule
    {
        public const string RuleName = Constants.InvoiceLineAmountGreaterThanZeroRuleName;
        public string Name { get; } = RuleName;
        public string Code { get; } = "MI35";
        ...
        private RuleResult CreateResult(RuleData ruleData)
        {
            ...
            {
                RuleName = Constants.InvoiceLineAmountGreaterThanZeroRuleName,
                Passed = ruleData.InvoiceLineAmount > 0,
        ...
        {
            if (!result.Passed)
                result.MessageList.Add(Constants.InvoiceLineAmountGreaterThanZeroValidation);
        }
    }
}
