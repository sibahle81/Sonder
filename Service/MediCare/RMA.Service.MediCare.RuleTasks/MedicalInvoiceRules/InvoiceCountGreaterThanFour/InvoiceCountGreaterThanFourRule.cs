...
{
    public class InvoiceCountGreaterThanFourRule : IRule
    {
        public const string RuleName = Constants.InvoiceCountGreaterThanFourRuleName;
        ...
        public RuleResult Execute(IRuleContext context)
        {
            try
            {
                ...
                if (ruleData != null)
                {
                    return CreateResult(ruleData.InvoiceCountIsGreaterThanFour);
                }
        ...
        {
            if (!result.Passed)
                result.MessageList.Add(Constants.InvoiceCountGreaterThanFourValidation);
        }
    }
}
