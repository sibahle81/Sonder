...
{
    public class UnmatchedClaimRule : IRule
    {
        public const string RuleName = Constants.UnmatchedClaim;
        public string Name { get; } = RuleName;
        public string Code { get; } = "MI15";
        ...
        public RuleResult Execute(IRuleContext context)
        {
            try
            {
                ...
                if (ruleData != null)
                {
                    return CreateResult(ruleData.IsUnmatchedClaimReferenceNumber);
                }
        ...
        {
            if (!result.Passed)
                result.MessageList.Add(Constants.UnmatchedClaimReferenceNumberRuleValidation);
        }
    }
}
