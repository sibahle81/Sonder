...
{
    public class ServiceDateIsValidRule : IRule
    {
        public const string RuleName = Constants.ServiceDateIsValideRuleName;
        ...
        public RuleResult Execute(IRuleContext context)
        {
            try
            {
                ...
                if (ruleData != null)
                {
                    return CreateResult(ruleData.ServiceDateInvoiceValid);
                }
                else
                {
                    return CreateNoDataRuleResult();
        ...
        {
            if (!result.Passed)
                result.MessageList.Add(Constants.ServiceDateRuleIsValideValidation);
        }
    }
}
