...
{
    public class TariffCodeRule : IRule
    {
        public const string RuleName = Constants.TariffCodeRuleName;
        ...
        public RuleResult Execute(IRuleContext context)
        {
            try
            {
                ...
                if (ruleData != null)
                {
                    return CreateResult(ruleData.IsValidTariffCode);
                }
        ...
        {
            if (!result.Passed)
                result.MessageList.Add(Constants.TariffCodeValidation);
        }
    }
}
