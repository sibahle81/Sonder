...
{
    public class ServiceDateInFutureRule : IRule
    {
        public const string RuleName = Constants.ServiceDateInFutureRuleName;
        public string Name { get; } = RuleName;
        public string Code { get; } = "MI16";
        ...
        private RuleResult CreateResult(RuleData ruleData)
        {
            ...
            {
                RuleName = Constants.ServiceDateInFutureRuleName,
                Passed = (Convert.ToDateTime(ruleData.ServiceDate).Date <= DateTimeHelper.SaNow.Date),
        ...
        {
            if (!result.Passed)
                result.MessageList.Add(Constants.ServiceDateInFutureValidation);
        }
    }
}
