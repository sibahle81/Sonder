...
{
    public class medical_TreatmentPlanConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<medical_TreatmentPlan>
    {
        public medical_TreatmentPlanConfiguration()
            : this("medical")
        {
        }

        public medical_TreatmentPlanConfiguration(string schema)
        {
            ToTable("TreatmentPlan", schema);
            HasKey(x => x.Id);
