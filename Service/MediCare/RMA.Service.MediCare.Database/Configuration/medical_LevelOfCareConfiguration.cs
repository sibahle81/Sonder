...
{
    public class medical_LevelOfCareConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<medical_LevelOfCare>
    {
        public medical_LevelOfCareConfiguration()
            : this("medical")
        {
        }

        public medical_LevelOfCareConfiguration(string schema)
        {
            ToTable("LevelOfCare", schema);
            HasKey(x => x.Id);
