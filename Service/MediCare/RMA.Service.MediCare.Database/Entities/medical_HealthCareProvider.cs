...
{
    public partial class medical_HealthCareProvider : IAuditableEntity, ISoftDeleteEntity, IEntityStatus
    {
        ...
        public bool? IsJvPartner { get; set; } // IsJvPartner

        // Reverse navigation

        /// <summary>
        /// Child medical_PmpRegionTransfers where [PMPRegionTransfer].[HealthCareProviderId] point to this entity (FK_PMPRegionTransfer_HealthCareProvider)
        /// </summary>
        public virtual System.Collections.Generic.ICollection<medical_PmpRegionTransfer> PmpRegionTransfers { get; set; } // PMPRegionTransfer.FK_PMPRegionTransfer_HealthCareProvider
        /// <summary>
        /// Child medical_SwitchBatchInvoices where [SwitchBatchInvoice].[HealthCareProviderId] point to this entity (FK_SwitchBatchInvoice_HealthCareProvider)
        /// </summary>
        public virtual System.Collections.Generic.ICollection<medical_SwitchBatchInvoice> SwitchBatchInvoices { get; set; } // SwitchBatchInvoice.FK_SwitchBatchInvoice_HealthCareProvider

        public medical_HealthCareProvider()
        {
            IsExcludeAutoPay = false;
            PmpRegionTransfers = new System.Collections.Generic.List<medical_PmpRegionTransfer>();
