...
{
    public class PreAuthorizationProsthetistQuoteReviewWizard : IWizardProcess
    {
        ...
        public PreAuthorizationProsthetistQuoteReviewWizard(
        ...
        public async Task<int> StartWizard(IWizardContext context)
        {
            ...
            var label = "Pre-Authorization Prosthetist Quote Review ";
