...
{
    public class PreAuthorizationProstheticReviewWizard : IWizardProcess
    {
        ...
        public PreAuthorizationProstheticReviewWizard(
        ...
        public async Task<int> StartWizard(IWizardContext context)
        {
            ...
            var label = "Prosthetic Pre-Authorization Review";
            
            if (workItemModel.HealthCareProviderId > 0)
            {
                var hcp = await _rolePlayerService.GetRolePlayer(workItemModel.HealthCareProviderId);
                if (hcp != null)
                    label = hcp.DisplayName;
            }
        ...
        public async Task SubmitWizard(IWizardContext context)
        {
            ...
            await _preAuthorisationService.UpdatePreAuthorisation(preAuthForm);
        ...
        public async Task<RuleRequestResult> ExecuteWizardRules(IWizardContext context)
        {
            ...
            IRule prostheticEarlyReplacementRule = new ProstheticEarlyReplacementRule();
            ...
            //Prosthetic Early Replacement 
            _context.Data = await preAuthRulesHelper.GetPreAuthRuleData(personEventId, preAuthForm);
            var prostheticEarlyReplacementRuleResult = prostheticEarlyReplacementRule.Execute(_context);
            ruleRequestResult.RuleResults.Add(new RuleResult { Passed = prostheticEarlyReplacementRuleResult.Passed, RuleName = prostheticEarlyReplacementRuleResult.RuleName, MessageList = prostheticEarlyReplacementRuleResult.MessageList });
            ...
            ruleRequestResult.OverallSuccess = (claimLiabilityStatusResult.Passed && preAuthFromDateRuleResult.Passed
                                               ...
                                               && claimStpStatusResult.Passed && claimInjuryResult.Passed && duplicatePreAuthResult.Passed && prostheticEarlyReplacementRuleResult.Passed) || true;
