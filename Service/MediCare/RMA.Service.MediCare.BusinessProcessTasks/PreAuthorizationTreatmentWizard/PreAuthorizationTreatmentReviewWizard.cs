...
namespace RMA.Service.MediCare.BusinessProcessTasks.PreAuthorizationTreatmentWizard
{
    public class PreAuthorizationTreatmentReviewWizard : IWizardProcess
    {
        ...
        public PreAuthorizationTreatmentReviewWizard(IConfigurationService configuration,
        ...
        public async Task<int> StartWizard(IWizardContext context)
        {
            ...
            var label = "Treatment Pre-Authorization Review";
