...
namespace RMA.Service.MediCare.BusinessProcessTasks.HealthcareProvider
{
    public class HealthcareProviderBankingDetailsWizard : IWizardProcess
    {
        ...
        public HealthcareProviderBankingDetailsWizard(
        ...
        public async Task<int> StartWizard(IWizardContext context)
        {
            ...
            var label = $"Update Healthcare Provider Banking Details {rolePlayer.HealthCareProvider.Name}";
