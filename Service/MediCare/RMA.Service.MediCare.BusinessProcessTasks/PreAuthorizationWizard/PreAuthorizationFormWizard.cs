...
{
    public class PreAuthorizationFormWizard : IWizardProcess
    {
        ...
        public PreAuthorizationFormWizard(
        ...
        public async Task<int> StartWizard(IWizardContext context)
        {
            ...
            var label = "pre-authorization form ";
        ...
        public async Task SubmitWizard(IWizardContext context)
        {
            ...
            foreach (var recipient in recipients)
            {
                var userReminder = new UserReminder
                {
                    ...
                    Text = $"New Hospitalization Auth submitted by: {RmaIdentity.UsernameOrBlank}",
