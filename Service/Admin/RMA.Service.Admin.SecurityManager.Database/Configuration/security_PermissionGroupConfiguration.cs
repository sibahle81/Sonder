...
{
    public class security_PermissionGroupConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<security_PermissionGroup>
    {
        public security_PermissionGroupConfiguration()
            : this("security")
        {
        }

        public security_PermissionGroupConfiguration(string schema)
        {
            ToTable("PermissionGroup", schema);
            HasKey(x => x.Id);
