...
{
    public class security_AuditLogConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<security_AuditLog>
    {
        public security_AuditLogConfiguration()
            : this("security")
        {
        }

        public security_AuditLogConfiguration(string schema)
        {
