...
{
    public class security_RoleConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<security_Role>
    {
        public security_RoleConfiguration()
            : this("security")
        {
        }

        public security_RoleConfiguration(string schema)
        {
            ToTable("Role", schema);
            HasKey(x => x.Id);
