...
{
    public class security_NoteConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<security_Note>
    {
        public security_NoteConfiguration()
            : this("security")
        {
        }

        public security_NoteConfiguration(string schema)
        {
            ToTable("Note", schema);
            HasKey(x => x.Id);
