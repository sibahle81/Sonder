...
{
    public class bpm_LastViewedConfig : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<bpm_LastViewed>
    {
        public bpm_LastViewedConfig()
            : this("bpm")
        {
        }

        public bpm_LastViewedConfig(string schema)
        {
