...
{
    public class bpm_AuditLogConfig : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<bpm_AuditLog>
    {
        public bpm_AuditLogConfig()
            : this("bpm")
        {
        }

        public bpm_AuditLogConfig(string schema)
        {
            ...
            Property(x => x.CorrolationToken).HasColumnName(@"CorrolationToken").HasColumnType("uniqueidentifier").IsOptional();
        }
    }
