...
{
    public class bpm_NoteConfig : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<bpm_Note>
    {
        public bpm_NoteConfig()
            : this("bpm")
        {
        }

        public bpm_NoteConfig(string schema)
        {
            ToTable("Note", schema);
            HasKey(x => x.Id);
