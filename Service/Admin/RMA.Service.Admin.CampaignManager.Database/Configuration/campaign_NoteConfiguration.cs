...
{
    public class campaign_NoteConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<campaign_Note>
    {
        public campaign_NoteConfiguration()
            : this("campaign")
        {
        }

        public campaign_NoteConfiguration(string schema)
        {
            ToTable("Note", schema);
            HasKey(x => x.Id);
