...
{
    public class common_BankBranchConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<common_BankBranch>
    {
        public common_BankBranchConfiguration()
            : this("common")
        {
        }

        public common_BankBranchConfiguration(string schema)
        {
            ToTable("BankBranch", schema);
            HasKey(x => x.Id);
            ...
            // Foreign keys
            HasRequired(a => a.Bank).WithMany(b => b.BankBranches).HasForeignKey(c => c.BankId).WillCascadeOnDelete(false); // FK_BankBranch_Bank
        }
    }
