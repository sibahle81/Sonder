...
{
    public class common_PrimeRateConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<common_PrimeRate>
    {
        public common_PrimeRateConfiguration()
            : this("common")
        {
        }

        public common_PrimeRateConfiguration(string schema)
        {
            ToTable("PrimeRate", schema);
            HasKey(x => x.Id);
