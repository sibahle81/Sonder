...
{
    public class common_CauseOfDeathTypeConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<common_CauseOfDeathType>
    {
        public common_CauseOfDeathTypeConfiguration()
            : this("common")
        {
        }

        public common_CauseOfDeathTypeConfiguration(string schema)
        {
            ToTable("CauseOfDeathType", schema);
            HasKey(x => x.Id);
