...
{
    public class common_IndustryConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<common_Industry>
    {
        public common_IndustryConfiguration()
            : this("common")
        {
        }

        public common_IndustryConfiguration(string schema)
        {
            ToTable("Industry", schema);
            HasKey(x => x.Id);
