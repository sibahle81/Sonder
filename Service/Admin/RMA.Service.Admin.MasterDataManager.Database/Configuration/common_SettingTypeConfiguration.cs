...
{
    public class common_SettingTypeConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<common_SettingType>
    {
        public common_SettingTypeConfiguration()
            : this("common")
        {
        }

        public common_SettingTypeConfiguration(string schema)
        {
