...
{
    public class common_StateProvinceConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<common_StateProvince>
    {
        public common_StateProvinceConfiguration()
            : this("common")
        {
        }

        public common_StateProvinceConfiguration(string schema)
        {
            ...
            // Foreign keys
            HasRequired(a => a.Country).WithMany(b => b.StateProvinces).HasForeignKey(c => c.CountryId).WillCascadeOnDelete(false); // FK_common.StateProvince_Country
        }
    }
