...
{
    public class common_ErrorTypeConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<common_ErrorType>
    {
        public common_ErrorTypeConfiguration()
            : this("common")
        {
        }

        public common_ErrorTypeConfiguration(string schema)
        {
            ToTable("ErrorType", schema);
            HasKey(x => x.Id);
