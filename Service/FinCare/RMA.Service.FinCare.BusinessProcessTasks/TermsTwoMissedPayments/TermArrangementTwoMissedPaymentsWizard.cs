...
{
    public class TermArrangementTwoMissedPaymentsWizard : IWizardProcess
    {
        private readonly ITermsArrangementService _termsArrangementService;
        public TermArrangementTwoMissedPaymentsWizard(ITermsArrangementService termsArrangementService)
        {
