...
namespace RMA.Service.FinCare.BusinessProcessTasks.CreditNote
{
    public class CreditNoteWizard : IWizardProcess
    {
        private readonly IPaymentAllocationService _paymentAllocationService;
        private readonly IBillingService _billingService;

        public CreditNoteWizard(IBillingService billingService, IPaymentAllocationService paymentAllocationService)
        {
