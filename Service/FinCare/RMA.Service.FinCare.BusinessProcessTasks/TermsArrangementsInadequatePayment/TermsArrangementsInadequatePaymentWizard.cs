...
namespace RMA.Service.FinCare.BusinessProcessTasks.TermsArrangementsInadequatePayment
{
    public class TermsArrangementsInadequatePaymentWizard : IWizardProcess
    {
        private readonly ITermsArrangementService _termsArrangementService;

        public TermsArrangementsInadequatePaymentWizard(ITermsArrangementService termsArrangementService)
        {
        ...
        public async Task SubmitWizard(IWizardContext context)
        {
            try
            {
                _ = Task.Run(() => _termsArrangementService.SendEmailNotification(context.LinkedItemId));
            }
            catch (Exception)
            {
                throw;
