...
namespace RMA.Service.FinCare.BusinessProcessTasks.PaymentReversals
{
    public class PaymentReversalWizard : IWizardProcess
    {
        private readonly IInvoiceService _invoiceService;
        public PaymentReversalWizard(IInvoiceService invoiceService)
        {
        ...
        public async Task SubmitWizard(IWizardContext context)
        {
            ...
            await _invoiceService.GenerateAdhocInvoice((int)payment.PolicyId, payment.Amount, DateTime.Now.Month);
        }
