...
{
    public class DuplicateInvoiceMonitorTask : IScheduledTaskHandler
    {
        private readonly IInvoiceService _invoiceService;
        public DuplicateInvoiceMonitorTask(IInvoiceService invoiceService)
        {
            _invoiceService = invoiceService;
        }
        public async Task<bool> ExecuteTask(int scheduledTaskId)
        {
            await _invoiceService.MonitorDuplicateInvoices();
            return true;
        }
