...
{
    public class ProcessAbilityPostingItemsTask : IScheduledTaskHandler
    {
        private readonly IAbilityCollectionsService _abilityCollectionsService;

        public ProcessAbilityPostingItemsTask(IAbilityCollectionsService abilityCollectionsService)
        {
        ...
        {
            Task.Run(() => _abilityCollectionsService.ProcessAbilityPostingItems()).ConfigureAwait(true);
