...
{
    public class GenerateCollectionsTask : IScheduledTaskHandler
    {
        private readonly ICollectionService _collectionService;

        public GenerateCollectionsTask(ICollectionService collectionService)
        {
        ...
        {
            await _collectionService.GenerateCollections();
            return true;
        }
