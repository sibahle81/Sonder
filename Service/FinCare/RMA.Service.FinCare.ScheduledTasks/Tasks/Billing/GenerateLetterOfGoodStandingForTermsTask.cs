...
{
    public class GenerateLetterOfGoodStandingForTermsTask : IScheduledTaskHandler
    {
        private readonly ITermsArrangementService _termsArrangementService;

        public GenerateLetterOfGoodStandingForTermsTask(ITermsArrangementService termsArrangementService)
        {
        ...
        {
            await _termsArrangementService.ProcessPaidTermAccounts();
            return true;
        }
