...
{
    public class SendCoidCreditNotesTask : IScheduledTaskHandler
    {
        private readonly IInvoiceService _invoiceService;

        public SendCoidCreditNotesTask(IInvoiceService invoiceService)
        {
        ...
        {
            await _invoiceService.SendCoidCreditNotes();
            return true;
        }
