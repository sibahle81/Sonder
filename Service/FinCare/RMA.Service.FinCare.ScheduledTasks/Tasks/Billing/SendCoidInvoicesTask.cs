...
{
    public class SendCoidInvoicesTask : IScheduledTaskHandler
    {
        private readonly IInvoiceService _invoiceService;

        public SendCoidInvoicesTask(IInvoiceService invoiceService)
        {
        ...
        {
            await _invoiceService.SendCoidInvoices();
            return true;
        }
