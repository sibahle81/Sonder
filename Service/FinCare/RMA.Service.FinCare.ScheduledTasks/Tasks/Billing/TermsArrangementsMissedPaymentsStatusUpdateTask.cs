...
namespace RMA.Service.FinCare.ScheduledTasks.Tasks.Billing
{
    ...
    public class TermsArrangementsMissedPaymentsStatusUpdateTask : IScheduledTaskHandler
    {
        private readonly ITermsArrangementService _termsArrangementService;

        public TermsArrangementsMissedPaymentsStatusUpdateTask(ITermsArrangementService termsArrangementService)
        {
        ...
        {
            await _termsArrangementService.UpdateTermsArrangementsMissedPaymentsStatus();
            return true;
        }
