...
{
    public class RaiseInterestOnOverDueInvoicesTask : IScheduledTaskHandler
    {
        private readonly IInvoiceService _invoiceService;

        public RaiseInterestOnOverDueInvoicesTask(IInvoiceService invoiceService)
        {
        ...
        {
            await _invoiceService.RaiseInterestOnOverDueInvoices();
            return true;
        }
