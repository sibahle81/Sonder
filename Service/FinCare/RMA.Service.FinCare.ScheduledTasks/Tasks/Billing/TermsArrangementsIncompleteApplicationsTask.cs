...
{
    public class TermsArrangementsIncompleteApplicationsTask : IScheduledTaskHandler
    {
        private readonly ITermsArrangementService _termsArrangementService;

        public TermsArrangementsIncompleteApplicationsTask(ITermsArrangementService termsArrangementService)
        {
        ...
        {
            await _termsArrangementService.ProcessTermsArrangementsIncompleteApplications();
            return true;
        }
    }
}
