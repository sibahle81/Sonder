...
{
    public class ProcessEFTPaymentsTask : IScheduledTaskHandler
    {
        private readonly ICollectionService _collectionService;
        public ProcessEFTPaymentsTask(ICollectionService collectionService)
        {
        ...
        {
            await _collectionService.ProcessEFTPayments();
            return true;
        }
