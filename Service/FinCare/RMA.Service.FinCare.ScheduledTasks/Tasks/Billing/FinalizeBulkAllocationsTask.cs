...
{
    public class FinalizeBulkAllocationsTask : IScheduledTaskHandler
    {
        private readonly IPaymentAllocationService _paymentAllocationService;

        public FinalizeBulkAllocationsTask(IPaymentAllocationService paymentAllocationService)
        {
        ...
        {
            await _paymentAllocationService.FinalizeBulkAllocation();
            return true;
        }
