...
{
    public class SubmitCollectionsTask : IScheduledTaskHandler
    {
        private readonly ICollectionService _collectionService;

        public SubmitCollectionsTask(ICollectionService collectionService)
        {
        ...
        {
            await _collectionService.QueuePendingCollections(null, null);
            return true;
        }
