...
{
    public class SendGroupInvoicesTask : IScheduledTaskHandler
    {
        private readonly IInvoiceService _invoiceService;

        public SendGroupInvoicesTask(IInvoiceService invoiceService)
        {
        ...
        {
            await _invoiceService.SendGroupInvoices();
            return true;
        }
