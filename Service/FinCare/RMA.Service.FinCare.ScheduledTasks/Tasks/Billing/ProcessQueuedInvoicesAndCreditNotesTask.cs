...
{
    public class ProcessQueuedInvoicesAndCreditNotesTask : IScheduledTaskHandler
    {
        private readonly IInvoiceService _invoiceService;

        public ProcessQueuedInvoicesAndCreditNotesTask(IInvoiceService invoiceService)
        {
