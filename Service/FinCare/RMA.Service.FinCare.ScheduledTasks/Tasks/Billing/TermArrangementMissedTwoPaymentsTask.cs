...
{
    public class TermArrangementMissedTwoPaymentsTask : IScheduledTaskHandler
    {
        private readonly ITermsArrangementService _termsArrangementService;
        public TermArrangementMissedTwoPaymentsTask(ITermsArrangementService termsArrangementService)
        {
