...
{
    public class ProcessExternalDebitOrdersTask : IScheduledTaskHandler
    {
        private readonly ICollectionService _collectionService;

        public ProcessExternalDebitOrdersTask(ICollectionService collectionService)
        {
        ...
        {
            await _collectionService.DoExternalCollectionReconcilations();
