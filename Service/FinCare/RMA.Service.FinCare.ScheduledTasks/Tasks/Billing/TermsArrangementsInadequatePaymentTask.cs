...
{
    public class TermsArrangementsInadequatePaymentTask : IScheduledTaskHandler
    {
        private readonly ITermsArrangementService _termsArrangementService;

        public TermsArrangementsInadequatePaymentTask(ITermsArrangementService termsArrangementService)
        {
        ...
        {
            await _termsArrangementService.CreateTermsArrangementsInadequatePaymentWizard();
            return true;
        }
    }
}
