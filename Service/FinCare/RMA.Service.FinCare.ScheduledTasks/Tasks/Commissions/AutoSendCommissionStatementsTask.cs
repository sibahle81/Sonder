...
{
    public class AutoSendCommissionStatementsTask : IScheduledTaskHandler
    {
        private ICommissionService _commissionService;

        public AutoSendCommissionStatementsTask(ICommissionService commissionService)
        {
        ...
        {
            await _commissionService.AutoSendCommissionStatements();
            return true;
        }
