...
{
    public partial class payment_ManageFinanceUser : IAuditableEntity, ISoftDeleteEntity
    {
        public int ManageFinanceUserId { get; set; } // ManageFinanceUserId (Primary key)
        ...
        public payment_ManageFinanceUser()
        {
            InitializePartial();
        }
