...
{
    public partial class Load_MyValuePlusDeduction : ILazyLoadSafeEntity
    {
        ...
        public string EmployeeNumber { get; set; } // EmployeeNumber (length: 64)
        public string PayrollCode { get; set; } // PayrollCode (length: 32)

        public Load_MyValuePlusDeduction()
        {
            InitializePartial();
        }
