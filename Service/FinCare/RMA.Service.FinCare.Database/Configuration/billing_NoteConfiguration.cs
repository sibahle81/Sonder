...
{
    public class billing_NoteConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<billing_Note>
    {
        public billing_NoteConfiguration()
            : this("billing")
        {
        }

        public billing_NoteConfiguration(string schema)
        {
            ToTable("Note", schema);
            HasKey(x => x.Id);
