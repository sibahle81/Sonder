...
{
    public class payment_NoteConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<payment_Note>
    {
        public payment_NoteConfiguration()
            : this("payment")
        {
        }

        public payment_NoteConfiguration(string schema)
        {
            ToTable("Note", schema);
            HasKey(x => x.Id);
