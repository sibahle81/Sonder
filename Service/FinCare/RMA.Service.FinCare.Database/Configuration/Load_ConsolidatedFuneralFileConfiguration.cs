...
{
    public class Load_ConsolidatedFuneralFileConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<Load_ConsolidatedFuneralFile>
    {
        public Load_ConsolidatedFuneralFileConfiguration()
            : this("Load")
        {
        }

        public Load_ConsolidatedFuneralFileConfiguration(string schema)
        {
            ToTable("ConsolidatedFuneralFile", schema);
            HasKey(x => x.Id);
