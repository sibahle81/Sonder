...
{
    public class Load_PremiumListingFileConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<Load_PremiumListingFile>
    {
        public Load_PremiumListingFileConfiguration()
            : this("Load")
        {
        }

        public Load_PremiumListingFileConfiguration(string schema)
        {
            ToTable("PremiumListingFile", schema);
            HasKey(x => x.Id);
