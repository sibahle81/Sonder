...
{
    public class Load_ConsolidatedFuneralErrorConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<Load_ConsolidatedFuneralError>
    {
        public Load_ConsolidatedFuneralErrorConfiguration()
            : this("Load")
        {
        }

        public Load_ConsolidatedFuneralErrorConfiguration(string schema)
        {
            ToTable("ConsolidatedFuneralError", schema);
            HasKey(x => x.Id);
