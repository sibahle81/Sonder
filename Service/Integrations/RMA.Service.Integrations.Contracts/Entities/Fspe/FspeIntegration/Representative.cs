...
{
    [XmlRoot(ElementName = "Representative", Namespace = "http://www.astutefse.com/schemas/fse/1.0")]
    public class Representative
    {
        ...
        [XmlElement(ElementName = "Tier1", Namespace = "http://www.astutefse.com/schemas/fse/1.0")]
        public string Tier1 { get; set; }
        [XmlElement(ElementName = "Tier2", Namespace = "http://www.astutefse.com/schemas/fse/1.0")]
        public string Tier2 { get; set; }
        [XmlElement(ElementName = "FspRepCOBs", Namespace = "http://www.astutefse.com/schemas/fse/1.0")]
        public FspRepCOBs FspRepCOBs { get; set; }
    }
}
