...
namespace RMA.Service.Billing.Database.Entities
{
    public partial class billing_Interest : IAuditableEntity, ISoftDeleteEntity
    {
        ...
        /// <summary>
        /// Parent client_FinPayee pointed by [Interest].([RolePlayerId]) (FK_Interest_FinPayee)
        /// </summary>
        public virtual client_FinPayee FinPayee { get; set; } // FK_Interest_FinPayee

        /// <summary>
        /// Parent common_Period pointed by [Interest].([PeriodId]) (FK_Interest_Period)
        /// </summary>
        public virtual common_Period Period { get; set; } // FK_Interest_Period
