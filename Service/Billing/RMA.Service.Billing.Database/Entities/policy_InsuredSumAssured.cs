...
namespace RMA.Service.Billing.Database.Entities
{
    public partial class policy_InsuredSumAssured : IAuditableEntity, ISoftDeleteEntity
    {
        ...
        /// <summary>
        /// Parent client_Person pointed by [InsuredSumAssured].([PersonId]) (FK_InsuredSumAssured_Person)
        /// </summary>
        public virtual client_Person Person { get; set; } // FK_InsuredSumAssured_Person

        /// <summary>
        /// Parent policy_PolicyBenefitDetail pointed by [InsuredSumAssured].([BenefitDetailId]) (FK_InsuredSumAssured_PolicyBenefitDetail)
        /// </summary>
        public virtual policy_PolicyBenefitDetail PolicyBenefitDetail { get; set; } // FK_InsuredSumAssured_PolicyBenefitDetail
