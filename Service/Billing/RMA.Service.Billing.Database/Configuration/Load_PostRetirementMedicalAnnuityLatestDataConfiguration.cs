...
{
    public class Load_PostRetirementMedicalAnnuityLatestDataConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<Load_PostRetirementMedicalAnnuityLatestData>
    {
        public Load_PostRetirementMedicalAnnuityLatestDataConfiguration()
            : this("Load")
        {
        }

        public Load_PostRetirementMedicalAnnuityLatestDataConfiguration(string schema)
        {
            ToTable("PostRetirementMedicalAnnuityLatestData", schema);
            ...
            Property(x => x.PromisedMedicalFamilyIndicatorAtRetirement).HasColumnName(@"PromisedMedicalFamilyIndicatorAtRetirement").HasColumnType("varchar").IsOptional().IsUnicode(false).HasMaxLength(50);
            ...
            Property(x => x.ChildOneDateOfDate).HasColumnName(@"ChildOneDateOfDate").HasColumnType("varchar").IsOptional().IsUnicode(false).HasMaxLength(50);
            ...
            Property(x => x.VopdStatus).HasColumnName(@"VopdStatus").HasColumnType("varchar").IsOptional().IsUnicode(false).HasMaxLength(50);
            Property(x => x.IsSubsidyProcessed).HasColumnName(@"IsSubsidyProcessed").HasColumnType("bit").IsOptional();
