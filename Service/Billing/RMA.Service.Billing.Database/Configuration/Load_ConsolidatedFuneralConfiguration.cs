...
{
    public class Load_ConsolidatedFuneralConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<Load_ConsolidatedFuneral>
    {
        public Load_ConsolidatedFuneralConfiguration()
            : this("Load")
        {
        }

        public Load_ConsolidatedFuneralConfiguration(string schema)
        {
            ToTable("ConsolidatedFuneral", schema);
            HasKey(x => x.Id);
            ...
            Property(x => x.Premium).HasColumnName(@"Premium").HasColumnType("varchar").IsOptional().IsUnicode(false).HasMaxLength(64);
            Property(x => x.CoverAmount).HasColumnName(@"CoverAmount").HasColumnType("varchar").IsOptional().IsUnicode(false).HasMaxLength(64);
            ...
            Property(x => x.PersalNumber).HasColumnName(@"PersalNumber").HasColumnType("varchar").IsOptional().IsUnicode(false).HasMaxLength(32);
            ...
            Property(x => x.PaymentMethod).HasColumnName(@"PaymentMethod").HasColumnType("varchar").IsOptional().IsUnicode(false).HasMaxLength(64);
        }
    }
