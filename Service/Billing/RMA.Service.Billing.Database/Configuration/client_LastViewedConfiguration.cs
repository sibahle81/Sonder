...
{
    public class client_LastViewedConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<client_LastViewed>
    {
        public client_LastViewedConfiguration()
            : this("client")
        {
        }

        public client_LastViewedConfiguration(string schema)
        {
