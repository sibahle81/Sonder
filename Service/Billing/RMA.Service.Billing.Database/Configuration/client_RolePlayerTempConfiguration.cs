...
{
    public class client_RolePlayerTempConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<client_RolePlayerTemp>
    {
        public client_RolePlayerTempConfiguration()
            : this("client")
        {
        }

        public client_RolePlayerTempConfiguration(string schema)
        {
            ToTable("RolePlayerTemp", schema);
