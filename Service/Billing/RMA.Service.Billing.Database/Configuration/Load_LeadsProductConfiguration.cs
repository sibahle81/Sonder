...
{
    public class Load_LeadsProductConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<Load_LeadsProduct>
    {
        public Load_LeadsProductConfiguration()
            : this("Load")
        {
        }

        public Load_LeadsProductConfiguration(string schema)
        {
            ToTable("LeadsProduct", schema);
            HasKey(x => x.Id);
            ...
            Property(x => x.ProductOption).HasColumnName(@"ProductOption").HasColumnType("varchar").IsOptional().IsUnicode(false).HasMaxLength(32);
            ...
            Property(x => x.MainRowNumber).HasColumnName(@"MainRowNumber").HasColumnType("varchar").IsOptional().IsUnicode(false).HasMaxLength(50);
