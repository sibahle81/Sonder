...
{
    public class policy_LastViewedConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<policy_LastViewed>
    {
        public policy_LastViewedConfiguration()
            : this("policy")
        {
        }

        public policy_LastViewedConfiguration(string schema)
        {
