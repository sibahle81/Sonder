...
{
    public class policy_PolicyTempConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<policy_PolicyTemp>
    {
        public policy_PolicyTempConfiguration()
            : this("policy")
        {
        }

        public policy_PolicyTempConfiguration(string schema)
        {
            ToTable("PolicyTemp", schema);
            HasKey(x => x.PolicyId);
