CREATE Procedure [debt].[GetDepartmentList]
(
...
UNION ALL SELECT 13 AS DepartmentId, 'Colleagues' AS DepartmentName, 'Colleagues' DisplayName
UNION ALL SELECT 14 AS DepartmentId, 'TeamLeader' AS DepartmentName, 'Team Leader' DisplayName
...
--exec [debt].[GetDepartmentList] 'c'  -- Parameter @SearchCreatia departmentname search