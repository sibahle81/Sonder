CREATE   Procedure  [debt].[GetReassignAgentList]  
As 
Begin 
SELECT t.Id, t.Email, t.UserName From(
select   
...
and [security].[PermissionGroup].Name in ('Debtor Collection')
)
as t order by t.UserName  
End
--exec [debt].[GetReassignAgentList] 