...
---- EXEC [policy].[BusinessWeeklyReport] '2020-07-05', '2021-02-08'
---- =============================================
 CREATE PROCEDURE [policy].[BusinessWeeklyReport]
...
BEGIN
	...
	and paRp.[RolePlayerIdentificationTypeId] = 1
	and paPol.[CreatedDate] between @StartDate and @EndDate
	and DATEDIFF(WEEK, DATEADD(MONTH, DATEDIFF(MONTH, 0, paPol.[CreatedDate]), 0), paPol.[CreatedDate]) +1 = @Week
	group by 
		paPol.[PolicyNumber],
