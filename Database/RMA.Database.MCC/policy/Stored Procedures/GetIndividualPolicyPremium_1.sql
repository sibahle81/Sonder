CREATE   PROCEDURE [policy].[GetIndividualPolicyPremium] (
...
as begin
	...
	declare @premium decimal(8, 2) = [policy].[CalculateIndividualPolicyPremium] (@baseRate, @adminPercentage, @commissionPercentage, @binderFeePercentage)
