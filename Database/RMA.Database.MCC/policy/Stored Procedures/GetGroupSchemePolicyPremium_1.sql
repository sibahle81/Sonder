...
CREATE   PROCEDURE [policy].[GetGroupSchemePolicyPremium] (
...
as begin
	...
	*/
	...
	declare @premium decimal(8, 2) = [policy].[CalculateGroupSchemePolicyPremium] (@baseRate, @adminPercentage, @commissionPercentage, @binderFeePercentage, @premiumAdjustmentPercentage)
