CREATE PROCEDURE [policy].[NumberOFLivesCLASSIV]
AS
BEGIN


If(OBJECT_ID('tempdb..#TempNUmberOFLivesCLASSIV') Is Not Null)
Begin
    Drop Table #TempNUmberOFLivesCLASSIV
End

create table #TempNUmberOFLivesCLASSIV
(
...
INSERT INTO #TempNUmberOFLivesCLASSIV(ROEStatus)
 VALUES ('Not Updated')
...
UPDATE #TempNUmberOFLivesCLASSIV
...
SELECT * FROM #TempNUmberOFLivesCLASSIV
