...
-- EXEC [policy].[GetBrokerPerformanceReport] 'July', 2024
-- =============================================
CREATE PROCEDURE [policy].[GetBrokerPerformanceReport]
