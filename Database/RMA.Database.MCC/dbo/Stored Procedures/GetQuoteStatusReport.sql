CREATE PROCEDURE [dbo].[GetQuoteStatusReport]
...
BEGIN
	...
	SELECT [Quote].[QuoteNumber],[Quote].[CreatedDate],[QuoteStatus].[Name], [Company].CompensationFundRegistrationNumber,[Company].[Name] AS Membername, [Contact].[Name] AS ContactPerson,[ClientType].[Name] AS ClientType, COUNT([LeadProduct].[LeadProductId]) AS ProductsInteresed FROM [quote].[Quote][Quote] INNER JOIN
