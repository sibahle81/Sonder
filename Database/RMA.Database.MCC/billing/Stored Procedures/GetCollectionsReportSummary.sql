CREATE PROCEDURE [billing].[GetCollectionsReportSummary]
AS
select 
sum(pp.InstallmentPremium) as 'SumPremium',
sum(ci.TotalInvoiceAmount) as 'SumInvoiceAmount',
sum(bt.Amount) as  'SumPremiumReceived'
