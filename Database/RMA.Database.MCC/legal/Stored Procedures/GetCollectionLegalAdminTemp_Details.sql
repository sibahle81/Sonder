...
CREATE   Procedure [legal].[getCollectionLegalAdminTemp_Details]
(
@RolePlayerId int
)
As
...
where [client].FinPayee.RolePlayerId = @RolePlayerId 
order by [client].[Roleplayer].DisplayName  
END

--exec [legal].[GetCollectionLegalAdminTemp_Details] 1009867