...
CREATE PROCEDURE [claim].[GetClaimsAssessorPool] 
(
	@PageNumber			AS	INT,
	@RowsOfPage			AS	INT,
...
BEGIN
 -- BEGIN --DEBUGGING
	...
	--	DECLARE	@SortingCol		AS VARCHAR(100) =	'PersonEventId';
	--	DECLARE	@SortType		AS VARCHAR(100) =	'ASC';
	--	DECLARE	@SearchCreatia	AS VARCHAR(150) =	'';
	--	DECLARE @ReAllocate		AS	bit	= 1;
	--	DECLARE @UserLoggedIn   AS	INT	= 0;
	--	DECLARE @workPoolId		AS	int	= 18;
