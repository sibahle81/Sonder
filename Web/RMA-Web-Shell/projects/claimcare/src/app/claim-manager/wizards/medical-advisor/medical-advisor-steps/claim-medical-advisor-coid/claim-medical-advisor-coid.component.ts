...
@Component({
  templateUrl: './claim-medical-advisor-coid.component.html'
})
export class ClaimMedicalAdvisorCoid extends WizardDetailBaseComponent<PersonEventModel> implements OnInit {
