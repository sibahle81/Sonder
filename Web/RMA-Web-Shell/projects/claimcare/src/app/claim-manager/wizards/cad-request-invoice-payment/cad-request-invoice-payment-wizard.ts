...
@Injectable({
  ...
  export class CADRequestInvoicePaymentWizard extends WizardContext {
    backLink = 'claimcare/';
    decline = 'claimcare/';
  
    constructor(componentFactoryResolver: ComponentFactoryResolver) {
      super(componentFactoryResolver);
      this.wizardComponents.push(new WizardComponentStep(0, 'CAD Request Approval For Invoice Payment', CADRequestInvoicePayment));
    }
