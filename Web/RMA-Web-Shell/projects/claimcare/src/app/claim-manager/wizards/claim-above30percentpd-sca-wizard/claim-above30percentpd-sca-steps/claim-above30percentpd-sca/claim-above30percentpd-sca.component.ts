...
@Component({
  templateUrl: './claim-above30percentpd-sca.component.html'
})
export class ClaimAbove30percentpdSCA extends WizardDetailBaseComponent<PersonEventModel> implements OnInit {
