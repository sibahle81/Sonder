...
@Component({
  ...
  templateUrl: './claim-beneficiary.component.html',
  styleUrls: ['./claim-beneficiary.component.css']
})
export class ClaimBeneficiaryComponent extends WizardDetailBaseComponent<ClaimRolePlayerBankingModel> {
  ...
  populateModel(): void {
    ...
    this.model.rolePlayer.tellNumber = value.tellNumber;
    this.model.rolePlayer.cellNumber = value.cellNumber;
    this.model.rolePlayer.emailAddress = value.emailAddress;
    this.model.rolePlayer.preferredCommunicationTypeId = value.preferredCommunicationTypeId;
    this.model.rolePlayer.rolePlayerIdentificationType = value.isNatural 
      ? RolePlayerIdentificationTypeEnum.Person 
      : RolePlayerIdentificationTypeEnum.Company;
    this.model.rolePlayer.person.firstName = value.firstName;
    this.model.rolePlayer.person.surname = value.surname;
    this.model.rolePlayer.person.idType = value.idType;
    this.model.rolePlayer.person.idNumber = value.idNumber;
    this.model.rolePlayer.person.dateOfBirth = this.dateOfBirth;
    this.model.rolePlayer.person.isAlive = true;
    this.model.rolePlayer.person.isStudying = value.isStudying;
    this.model.rolePlayer.person.isDisabled = value.isDisabled;
    this.model.rolePlayer.person.dateOfDeath = new Date();
    this.model.rolePlayer.person.deathCertificateNumber = '';
    this.model.rolePlayer.person.isVopdVerified = value.isVopdVerified;
    this.model.rolePlayer.person.dateVopdVerified = value.dateVopdVerified;
    this.model.rolePlayer.keyRoleTypeId = value.rolePlayerTypeId;
  ...
  getRolePlayerTypes() {
    ...
    this.rolePlayerService.getRolePlayerTypes(this.rolePlayerTypeIds).subscribe(
      data => {
        ...
        const person = this.model.rolePlayer;
        ...
        this.setCommunicationValidators({ value: this.model.rolePlayer.preferredCommunicationTypeId });
