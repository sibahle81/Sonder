...
@Component({
  templateUrl: './claim-earnings-validation.component.html'
})
export class ClaimEarningsValidation extends WizardDetailBaseComponent<PersonEventModel> implements OnInit {
