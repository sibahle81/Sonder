...
@Component({
  selector: 'first-medical-upload',
  templateUrl: './first-medical-upload.component.html',
  styleUrls: ['./first-medical-upload.component.css']
})
export class FirstMedicalUploadComponent extends UnSubscribe implements OnChanges {
  ...
  firstMedicalReportEnum: DocumentTypeEnum[] = [DocumentTypeEnum.FirstMedicalReport];
  ...
  getMedicalReportCategories(): void {
    this.lookupService.getMedicalReportCategories().subscribe(data => {
      ...
      if (this.personEvent && this.event && this.personEvent.firstMedicalReport && this.personEvent.firstMedicalReport.medicalReportForm.reportTypeId === +MedicalFormReportTypeEnum.FirstAccidentMedicalReport) {
  ...
  createForm() {
    ...
    if (this.personEvent.firstMedicalReport && this.personEvent.firstMedicalReport.medicalReportForm.reportTypeId === +MedicalFormReportTypeEnum.FirstAccidentMedicalReport) {
  ...
  saveMedicalReport() {
    ...
    this.firstMedicalReportForm.medicalReportForm.reportTypeId = MedicalFormReportTypeEnum.FirstAccidentMedicalReport;
  ...
  allDocumentsEmitted($event: GenericDocument[]) {
    const filteredDocuments = $event.filter(doc => doc.documentType === DocumentTypeEnum.FirstMedicalReport);
  ...
  readForm(): FirstMedicalReportForm {
    ...
    this.firstMedicalReportForm.medicalReportForm.consultationDate = this.form.controls.dateOfConsultation.value ? new Date(this.datePipeService.transform(this.form.controls.dateOfConsultation.value, Constants.dateString)) : null;
    ...
    if (this.isUnfitForWorkSelected == true || this.form.controls.isUnfitForWork.value && this.form.controls.isUnfitForWork.value === 'Yes') {
      this.firstMedicalReportForm.lastDayOff = this.form.controls.lastDayOff.value ? new Date(this.datePipeService.transform(this.form.controls.lastDayOff.value, Constants.dateString)) : null;
      this.firstMedicalReportForm.firstDayOff = this.form.controls.firstDayOff.value ? new Date(this.datePipeService.transform(this.form.controls.firstDayOff.value, Constants.dateString)) : null;
