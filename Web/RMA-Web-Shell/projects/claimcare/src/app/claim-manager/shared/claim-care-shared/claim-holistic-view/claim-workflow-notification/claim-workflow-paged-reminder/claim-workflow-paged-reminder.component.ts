...
import { PagedClaimWorkflowReminderDataSource } from './claim-workflow-paged-reminder.datasource';
import { AuthService } from 'projects/shared-services-lib/src/lib/services/security/auth/auth.service';

@Component({
  selector: 'app-claim-workflow-paged-reminder',
  templateUrl: './claim-workflow-paged-reminder.component.html',
  styleUrls: ['./claim-workflow-paged-reminder.component.css']
})
export class ClaimWorkflowPagedReminderComponent 
extends UnSubscribe
implements OnInit, OnChanges
{

@Input() personEventId: number;
@Output() selectedUserReminderEmit: EventEmitter<UserReminder> =
  new EventEmitter();
...
userReminderTypes = new Array<UserReminderTypeEnum>();
dataSource: PagedClaimWorkflowReminderDataSource;
...
constructor(
  ...
  this.userReminderTypes.push(UserReminderTypeEnum.Message);
  this.dataSource = new PagedClaimWorkflowReminderDataSource(
    this.userReminderService
  );
  this.dataSource.userId = this.user.id;
