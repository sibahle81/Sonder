...
@Component({
  ...
  templateUrl: './rejection-notification.component.html'
})
export class RejectionNotificationComponent extends WizardDetailBaseComponent<Notification> implements OnInit {
