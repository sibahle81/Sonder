...
import { ClaimTableProductivityDataSource } from 'projects/claimcare/src/app/claim-manager/views/dashboards/claim-table-productivity/claim-table-productivity.datasource'
...
@Component({
  selector: 'claim-table-productivity',
...
export class ClaimTableProductivityComponent implements OnInit {
  ...
  constructor(
    ...
    public dataSource: ClaimTableProductivityDataSource,
