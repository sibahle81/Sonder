...
export class SearchClaimantPolicyDataSource extends PagedDataSource<RolePlayerSearchResult> {
  ...
  getData(query: any): void {
    ...
    this.claimCareService.searchClaimantInsuredLives(query.query as string, query.pageNumber as number, query.pageSize as number, query.orderBy as string, query.sortDirection as string, query.showActive as boolean)
