...
import { CaseSearchComponent } from 'projects/marketingcare/src/app/marketing-manager/views/shared/case-search/case-search.component';
...
const routes: Routes = [
  {
    ...
    children: [
      { path: 'work-manager', loadChildren: () => import('projects/marketingcare/src/app/work-manager/work-manager.module').then(m => m.WorkManagerModule) },
      { path: 'case-search', component: CaseSearchComponent, data: { title: 'Marketing Case Search' }},
