...
@Component({
  selector: 'app-tax-rate-notes',
  templateUrl: './tax-rate-notes.component.html',
  styleUrls: ['./tax-rate-notes.component.css']
})
export class TaxRateNotesComponent extends WizardDetailBaseComponent<TaxRatesNotification> implements OnInit {
