...
@Component({
  selector: 'app-tax-rebates-notes',
  templateUrl: './tax-rebates-notes.component.html',
  styleUrls: ['./tax-rebates-notes.component.css']
})
export class TaxRebatesNotesComponent extends WizardDetailBaseComponent<TaxRebatesNotification> implements OnInit {
