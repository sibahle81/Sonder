...
@Component({
  selector: 'app-term-schedules-view',
  templateUrl: './term-schedules-view.component.html',
  styleUrls: ['./term-schedules-view.component.css']
})
export class TermSchedulesViewComponent implements OnInit {
