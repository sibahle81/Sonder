...
import { CaseSearchComponent } from 'projects/debtcare/src/app/debt-manager/views/shared/case-search/case-search.component';
...
const routes: Routes = [
  {
    ...
    children: [
      { path: 'work-manager', loadChildren: () => import('projects/debtcare/src/app/work-manager/work-manager.module').then(m => m.WorkManagerModule) },
      { path: 'case-search', component: CaseSearchComponent, data: { title: 'Debt Case Search' }},
