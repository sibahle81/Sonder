...
import { WorkItemSearchDataSource } from 'projects/debtcare/src/app/work-manager/datasources/work-item-search-datasource';
...
export class WorkItemSearchComponent implements OnInit, AfterViewInit {
  ...
  constructor(private readonly router: Router, private readonly wizardService: WizardService, private readonly wizardConfigurationService: WizardConfigurationService,
                private readonly debtService: DebtCareService) { }
  ngAfterViewInit(): void {
    
  }

  ngOnInit() {
    this.dataSource = new WorkItemSearchDataSource(this.debtService);
  }
