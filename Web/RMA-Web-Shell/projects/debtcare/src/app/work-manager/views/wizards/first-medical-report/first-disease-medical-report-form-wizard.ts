...
import { FirstDiseaseReportDetailsComponent } from 'projects/debtcare/src/app/work-manager/views/wizards/first-medical-report/first-disease-report-details/first-disease-report-details.component';
import { FirstDiseaseReportPtsdDetailsComponent } from 'projects/debtcare/src/app/work-manager/views/wizards/first-medical-report/first-disease-report-ptsd-details/first-disease-report-ptsd-details.component';
import { FirstDiseaseReportOccupationImpactDetailsComponent} from 'projects/debtcare/src/app/work-manager/views/wizards/first-medical-report/first-disease-report-occupation-impact-details/first-disease-report-occupation-impact-details.component';
