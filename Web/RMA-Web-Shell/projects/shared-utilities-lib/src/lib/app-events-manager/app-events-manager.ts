...
export class AppEventsManager {
    ...
    private tenantPreferences = new BehaviorSubject<TenantPreferences>(null);
    ...
    /** @description Triggers when the preferences changes. */
    onTenantPreferenceChanged = this.tenantPreferences.asObservable();
    ...
    /**
     * @description Set the tenant Preference.
     * @param preferences string Json string on the tenant preferences
     */
    setTenantPreferences(preferences: TenantPreferences): void {
        this.tenantPreferences.next(preferences);
    }
}
