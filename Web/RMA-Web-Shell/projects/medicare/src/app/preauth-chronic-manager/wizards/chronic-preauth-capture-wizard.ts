...
import { ChronicApplicationType } from '../../preauth-chronic-manager/views/chronic-application-type/chronic-application-type.component';
...
export class ChronicPreauthCaptureWizardContext extends WizardContext  {
  backLink = 'medicare/work-manager';
  

  constructor(componentFactoryResolver: ComponentFactoryResolver){
    super(componentFactoryResolver);
    this.captureChronicPreauthWizard();
  }
  ...
  captureChronicPreauthWizard() {
    ...
    this.wizardComponents.push(new WizardComponentStep(5, 'Chronic other details', ChronicApplicationType));
