...
@Component({
  selector: 'app-healthcare-provider-update-demographics',
  templateUrl: './healthcare-provider-update-demographics.component.html',
  styleUrls: ['./healthcare-provider-update-demographics.component.css']
})
export class HealthcareProviderUpdateDemographicsComponent extends WizardDetailBaseComponent<RolePlayer> implements OnInit {
  ...
  title:string = 'Review healthcare provider updated demographics: ';
