...
@Component({
  templateUrl: './hcp-member-register-user-contacts-dialog.component.html',
  styleUrls: ['./hcp-member-register-user-contacts-dialog.component.css']
})

export class HCPMemberRegisterUserContactsDialogComponent implements OnInit {
