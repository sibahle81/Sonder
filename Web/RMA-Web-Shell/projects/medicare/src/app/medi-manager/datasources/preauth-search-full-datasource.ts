...
@Injectable()
export class PreAuthorisationSearchFullDataSource extends PagedDataSource<PreAuthorisation> {
    ...
    getData(pageNumber: number, pageSize: number, orderBy: string = 'preAuthId', sortDirection: string = 'asc', query: string) {
        this.loadingSubject.next(true);

        this.mediCarePreAuthService.searchPreAuthorisations(pageNumber, pageSize, orderBy, sortDirection, query).pipe(
            catchError(() => of([])),
