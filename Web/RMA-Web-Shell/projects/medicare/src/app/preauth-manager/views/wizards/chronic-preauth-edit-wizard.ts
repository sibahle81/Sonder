...
export class ChronicPreAuthEditWizardContext extends WizardContext {
  ...
  constructor(componentFactoryResolver: ComponentFactoryResolver){
    ...
    this.wizardComponents.push(new WizardComponentStep(2, 'Edit Chronic other details', ChronicApplicationType));
  }
