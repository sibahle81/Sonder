...
@Component({
    selector: 'chronic-preauth-reviewer',
    templateUrl: './chronic-preauth-reviewer.component.html',
    styleUrls: ['./chronic-preauth-reviewer.component.css']
})
export class ChronicPreAuthReviewerComponent extends WizardDetailBaseComponent<PreAuthorisation> {
    preAuthTypeText = "Chronic Autorisation Details";
    ...
    chronicAuthDetails: PreAuthorisation;
    ...
    title:string='Chronic PreAuth Review';
    ...
    getData(): void {
        ...
        if (this.preAuthId > 0) {
            ...
            this.preAuth$
                ...
                .subscribe((data) => {
                    if (data !== null) {
                        this.mainPreAuthorisation = this.chronicAuthDetails = data;
                        this.personEventId = data.personEventId;
                        if(this.mainPreAuthorisation.chronicMedicationForms.length > 0){
                            this.title = 'Chronic New PreAuthorisation Review';
                            ...
                            this.title = 'Chronic Renewal PreAuthorisation Review';
                            this.documentTypeFilter.push(DocumentTypeEnum.DoctorsPrescriptionScript);
                    ...
                    () => {
                        if (this.mainPreAuthorisation !== null) {
                            if (this.mainPreAuthorisation.preAuthType == PreauthTypeEnum.ChronicMedication) {
                                this.healthCareProviderId = this.mainPreAuthorisation.healthCareProviderId;
                                this.changeDetector.detectChanges();
                                this.preAuthTypeText = "Chronic Autorisation Details";
    ...
    populateModel(): void {
        ...
        if (!isNullOrUndefined(this.preauthReviewComponentHospital)) {
            this.model.preAuthType = PreauthTypeEnum.ChronicMedication;
