...
@Component({
    selector: 'treatment-preauth-reviewer',
    templateUrl: './treatment-preauth-reviewer.component.html',
    styleUrls: ['./treatment-preauth-reviewer.component.css']
})
export class TreatmentPreAuthReviewerComponent extends WizardDetailBaseComponent<PreAuthorisation> {
    preAuthTypeText = "Treatment Autorisation Details";
    ...
    treatmentAuthDetails: PreAuthorisation;
    ...
    getData(): void {
        ...
        if (this.preAuthId > 0) {
            ...
            this.preAuth$
                ...
                .subscribe((data) => {
                    if (data !== null) {
                        this.mainPreAuthorisation = this.treatmentAuthDetails = data;
                    ...
                    () => {
                        if (this.mainPreAuthorisation !== null) {
                            if (this.mainPreAuthorisation.preAuthType == PreauthTypeEnum.Treatment) {
                                this.healthCareProviderId = this.mainPreAuthorisation.healthCareProviderId;
                                this.changeDetector.detectChanges();
                                this.preAuthTypeText = "Treatment Autorisation Details";
    ...
    populateModel(): void {
        ...
        if (!isNullOrUndefined(this.preauthReviewComponentHospital)) {
            this.model.preAuthType = PreauthTypeEnum.Treatment;
