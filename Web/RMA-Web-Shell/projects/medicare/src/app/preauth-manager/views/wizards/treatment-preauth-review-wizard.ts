...
export class TreatmentPreAuthReviewWizardContext extends WizardContext {
...
currentUser: User;
  ...
  constructor(componentFactoryResolver: ComponentFactoryResolver,) {
    ...
    if(this.currentUser?.isInternalUser){    
      this.wizardComponents.push(new WizardComponentStep(0, 'Review Treatment Auth', TreatmentPreAuthReviewerComponent));
    }
    else{
      this.wizardComponents.push(new WizardComponentStep(0, 'Holistic View', WizardMediHolisticViewComponent));
      this.wizardComponents.push(new WizardComponentStep(1, 'Review Treatment Auth', TreatmentPreAuthReviewerComponent));
    }
  }
