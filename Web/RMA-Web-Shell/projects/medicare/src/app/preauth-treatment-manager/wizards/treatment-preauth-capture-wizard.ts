...
export class TreatmentPreauthCaptureWizardContext extends WizardContext  {
  ...
  captureTreatmentPreauthWizard() {
    ...
    this.wizardComponents.push(new WizardComponentStep(5, 'Rehabilitation', RehabilitationFormComponent));
    this.wizardComponents.push(new WizardComponentStep(6, 'Claim reopening form', ClaimReopeningPreAuthComponent));
  }
