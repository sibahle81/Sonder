...
@Component({
  templateUrl: './declaration-variance-wizard.component.html'
})

export class DeclarationVarianceWizardComponent extends WizardDetailBaseComponent<Policy[]> implements OnInit {
