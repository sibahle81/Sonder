    ...
    @Component({
    templateUrl: './role-player-documents.component.html'
    })

    export class RolePlayerDocumentsComponent extends WizardDetailBaseComponent<RolePlayer> implements OnInit {
