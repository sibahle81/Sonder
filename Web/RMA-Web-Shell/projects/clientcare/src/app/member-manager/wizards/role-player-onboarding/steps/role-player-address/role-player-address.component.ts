    ...
    @Component({
    templateUrl: './role-player-address.component.html'
    })

    export class RolePlayerAddressComponent extends WizardDetailBaseComponent<RolePlayer> implements OnInit {
    ...
    onValidateModel(validationResult: ValidationResult): ValidationResult {
      if (!this.model.rolePlayerAddresses || this.model.rolePlayerAddresses?.length <= 0) {
