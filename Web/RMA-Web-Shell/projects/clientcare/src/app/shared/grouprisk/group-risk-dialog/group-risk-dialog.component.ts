...
@Component({
  selector: 'app-group-risk-dialog',
  templateUrl: './group-risk-dialog.component.html',
  styleUrls: ['./group-risk-dialog.component.css']
})
export class GroupRiskDialogComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<GroupRiskDialogComponent>,
