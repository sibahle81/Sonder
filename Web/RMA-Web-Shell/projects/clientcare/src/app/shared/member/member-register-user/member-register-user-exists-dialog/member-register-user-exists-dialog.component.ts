...
@Component({
  templateUrl: './member-register-user-exists-dialog.component.html',
  styleUrls: ['./member-register-user-exists-dialog.component.css']
})

export class MemberRegisterUserExistsDialogComponent implements OnInit {
