...
@Component({
  selector: 'app-vopd-mvp-manual-override-dialog',
  templateUrl: './vopd-mvp-manual-override-dialog.component.html',
  styleUrls: ['./vopd-mvp-manual-override-dialog.component.css']
})
export class VopdMvpManualOverrideDialogComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<VopdMvpManualOverrideDialogComponent>,
    @Inject(MAT_DIALOG_DATA) public data: any,
    private readonly formBuilder: UntypedFormBuilder, private readonly policyService: PolicyService, private alertService: AlertService,
  ) {
  ...
  submit() {
    ...
    this.policyService.overrideRolePlayerVopd_MVP(dateOfDeath, idNumber, firstname, surname, deceasedStatus, vopdDatetime, this.fileIdentifier).subscribe(
      response => {
        if (response) {
