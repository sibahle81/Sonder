...
@Component({
  selector: 'app-vopd-manual-verification-dialog',
  templateUrl: './vopd-manual-verification-dialog.component.html',
  styleUrls: ['./vopd-manual-verification-dialog.component.css']
})
export class VopdManualVerificationDialogComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<VopdManualVerificationDialogComponent>,
