...
@Component({
  selector: 'app-vopd-mvp-manual-verification-dialog',
  templateUrl: './vopd-mvp-manual-verification-dialog.component.html',
  styleUrls: ['./vopd-mvp-manual-verification-dialog.component.css']
})
//export class VopdMvpManualVerificationDialogComponent 
export class VopdMvpManualVerificationDialogComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<VopdMvpManualVerificationDialogComponent>,
    @Inject(MAT_DIALOG_DATA) public data: any,
    private readonly formBuilder: UntypedFormBuilder, private readonly policyService: PolicyService
  ) {
  ...
  submit() {
    ...
    this.policyService.overrideRolePlayerVopd(dateOfDeath, idNumber, firstname, surname, deceasedStatus, vopdDatetime, this.fileIdentifier).subscribe(
      response => {
        if (response) {
