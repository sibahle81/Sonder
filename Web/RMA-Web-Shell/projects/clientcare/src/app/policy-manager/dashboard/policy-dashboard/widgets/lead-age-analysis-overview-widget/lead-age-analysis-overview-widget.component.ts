...
import { LeadsSearchDataSource } from 'projects/clientcare/src/app/lead-manager/datasource/leads-search.datasource';
import { LeadDetails } from 'projects/clientcare/src/app/lead-manager/models/lead-details';
import { LeadService } from 'projects/clientcare/src/app/lead-manager/services/lead.service';
import { fromEvent, merge } from 'rxjs';
import { BehaviorSubject } from 'rxjs';
import { debounceTime, distinctUntilChanged, tap } from 'rxjs/operators';
import { Dashboard } from '../../../../shared/entities/dashboard/dashboard';
import { ClientTypeEnum } from '../../../../shared/enums/client-type-enum';
import { LeadClientStatusEnum } from '../../../../shared/enums/leadClientStatusEnum';
import { SLACompareEnum } from '../../../../shared/enums/sla-compare-enum';
...
export class LeadAgeAnalysisOverviewWidgetComponent implements OnInit {
  ...
  dataSource: LeadsSearchDataSource;
  showTableData = false;
  expanded = false;
  slaCompareEnum = SLACompareEnum;
  ...
  ngOnInit() {
    this.getData();
      this.dataSource = new LeadsSearchDataSource(this.leadService);
  ...
  // TODO
  setTable(AgeAnalysis: string) {
    this.currentQuery = AgeAnalysis;
