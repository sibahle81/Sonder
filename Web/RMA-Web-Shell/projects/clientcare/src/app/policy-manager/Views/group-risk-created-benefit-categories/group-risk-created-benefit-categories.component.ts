...
@Component({
  selector: 'app-group-risk-created-benefit-categories',
  templateUrl: './group-risk-created-benefit-categories.component.html',
  styleUrls: ['./group-risk-created-benefit-categories.component.css']
})
export class GroupRiskCreatedBenefitCategoriesComponent extends WizardDetailBaseComponent<GroupRisk> {
