...
@Component({
  selector: 'app-insured-lives-documents-group',
  templateUrl: './insured-lives-documents-group.component.html',
  styleUrls: ['./insured-lives-documents-group.component.css']
})

export class InsuredLivesDocumentsGroupComponent extends WizardDetailBaseComponent<PremiumListing> implements OnInit{
