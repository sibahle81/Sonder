...
@Injectable()
export class ImportGroupIndividualListDatasource extends Datasource {
    imports: Import[];
    counter = 0;
    ...
    getData(): void {
        this.startLoading('Loading group individuals imports...');
        this.counter = 0;
    ...
    getInsuredLivesUpload(): void {
        this.policyImportService.getImports(PolicyImportType.GroupInsuredLives).subscribe(
            imports => {
