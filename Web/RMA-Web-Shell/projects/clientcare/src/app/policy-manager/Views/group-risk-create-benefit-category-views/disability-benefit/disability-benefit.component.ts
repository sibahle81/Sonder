...
@Component({
  selector: 'create-benefit-category-disability',
  templateUrl: './disability-benefit.component.html',
  styleUrls: ['./disability-benefit.component.css']
})
export class GroupRiskCreateBenefitCategoryDisabilityComponent extends WizardDetailBaseComponent<GroupRiskPolicyCaseModel> {
