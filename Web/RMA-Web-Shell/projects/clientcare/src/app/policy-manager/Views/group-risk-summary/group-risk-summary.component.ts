...
@Component({
  selector: 'app-group-risk-summary',
  templateUrl: './group-risk-summary.component.html',
  styleUrls: ['./group-risk-summary.component.css']
})
export class GroupRiskSummaryComponent extends WizardDetailBaseComponent<GroupRisk> {
