...
@Component({
  selector: 'app-consolidated-funeral-members',
  templateUrl: './consolidated-funeral-members.component.html',
  styleUrls: ['./consolidated-funeral-members.component.css'],
  providers: [
    { provide: DateAdapter, useClass: MatDatePickerDateFormat },
    { provide: MAT_DATE_FORMATS, useValue: DatePickerDateFormat }
  ]
})
export class ConsolidatedFuneralMembersComponent extends WizardDetailBaseComponent<ConsolidatedFuneral> {
  ...
  populateForm(): void {
    ...
    this.consolidatedFuneralService.getConsolidatedFuneralVopdStatus(this.model.fileIdentifier).subscribe({
