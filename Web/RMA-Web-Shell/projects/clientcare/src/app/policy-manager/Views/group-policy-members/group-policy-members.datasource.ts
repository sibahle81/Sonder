...
export class GroupPolicyMembersDatasource extends PagedDataSource<PolicyMember> {

  public isLoading = false;
  public isChildPolicy = false;
  ...
  getData(query: any) {
    ...
    this.insuredLifeService.getInsuredLives(query.query, query.pageNumber, query.pageSize, query.orderBy, query.sortDirection, this.isChildPolicy).pipe(
      catchError(() => of([])),
