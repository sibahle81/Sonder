...
@Component({
  templateUrl: './rma-rml-cancel-policy.component.html',
  styleUrls: ['./rma-rml-cancel-policy.component.css']
})

export class RMARMLCancelPolicyComponent extends WizardDetailBaseComponent<PolicyStatusChangeAudit> implements OnInit {
  ...
  documentSet = DocumentSetEnum.CoidPolicyCancellation;
  ...
  getPolicy() {
    ...
    this.form.patchValue({
      effectiveDate: this.model.effectiveFrom ? new Date(this.model.effectiveFrom).getCorrectUCTDate() : new Date(this.policy.policyInceptionDate).getCorrectUCTDate()
    });
