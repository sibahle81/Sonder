...
export class ContinuePolicyIndividualWizard extends WizardContext {
  ...
  constructor(componentFactoryResolver: ComponentFactoryResolver) {
    ...
    this.wizardComponents.push(new WizardComponentStep(1, 'Main Member', MemberContinuePolicyComponent, false, true));
