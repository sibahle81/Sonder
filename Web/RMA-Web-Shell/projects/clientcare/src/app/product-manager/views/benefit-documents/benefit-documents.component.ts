...
@Component({
  selector: 'benefit-documents',
  templateUrl: '../../../../../../shared-components-lib/src/lib/document-management/document-management.component.html'
})

export class BenefitDocumentsComponent extends DocumentManagementComponent<Benefit> {
  documentSet = DocumentSetEnum.ProductBenefit;
