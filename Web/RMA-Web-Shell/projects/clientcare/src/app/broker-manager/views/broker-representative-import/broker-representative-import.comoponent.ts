...
@Injectable()
@Component({
    templateUrl: './broker-representative-import.component.html',
    styleUrls: ['./broker-representative-import.component.css']
})
export class BrokerRepresentativeImportComponent implements OnInit {
