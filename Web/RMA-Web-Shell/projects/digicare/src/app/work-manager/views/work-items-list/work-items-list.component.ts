...
export class WorkItemsListComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit() {
    this.dataSource = new WorkItemsDataSource(this.digiCareService);
  ...
  getActiveWorkItems(): void {
    ...
    this.digiCareService.getFilteredWorkItems(this.workItemTypeFilter, this.workItemCreator).subscribe(data => {
