...
@Component({
  selector: 'app-medical-form-viewer',
  templateUrl: './medical-form-viewer.component.html',
  styleUrls: ['./medical-form-viewer.component.css']
})
export class MedicalFormViewerComponent implements OnInit {
