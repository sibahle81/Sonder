...
@Component({
  selector: 'app-payment-pension-list',
  templateUrl: './payment-pension-list.component.html',
  styleUrls: ['./payment-pension-list.component.css']
})
export class PaymentPensionListComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.paymentPoolView = PaymentPoolViewTypeEnum.PensionsList;
