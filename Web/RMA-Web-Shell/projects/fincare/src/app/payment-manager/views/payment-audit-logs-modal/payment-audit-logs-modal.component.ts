...
import { AuditResult, AuditRequest } from 'projects/shared-components-lib/src/lib/audit/audit-models';
...
@Component({
  selector: 'app-payment-audit-logs-modal',
  templateUrl: './payment-audit-logs-modal.component.html',
  styleUrls: ['./payment-audit-logs-modal.component.css']
})
export class PaymentAuditLogsModalComponent extends ListFilteredComponent implements OnInit  {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<PaymentAuditLogsModalComponent>,
