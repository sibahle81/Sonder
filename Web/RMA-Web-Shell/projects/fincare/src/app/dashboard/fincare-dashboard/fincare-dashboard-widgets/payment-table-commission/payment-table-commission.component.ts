...
import { PaymentTableCommsionDataSource } from './payment-table-commission.datasource';

@Component({
  selector: 'payment-table-commission',
  templateUrl: './payment-table-commission.component.html',
  styleUrls: ['./payment-table-commission.component.css']
})
export class PaymentTableCommissionComponent implements OnInit {
  ...
  constructor(
    public dataSource: PaymentTableCommsionDataSource,
