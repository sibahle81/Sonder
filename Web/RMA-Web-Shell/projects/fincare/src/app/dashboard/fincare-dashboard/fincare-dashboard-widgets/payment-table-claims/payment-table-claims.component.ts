...
import { PaymentTableClaimsDataSource } from './payment-table-claims.datasource';


@Component({
  selector: 'payment-table-claims',
  templateUrl: './payment-table-claims.component.html',
  styleUrls: ['./payment-table-claims.component.css']
})
export class PaymentTableClaimsComponent implements OnInit {
  ...
  columnDefinitions: any[] = [
    { display: 'claim Number', def: 'claimReference', show: true },
  ...
  constructor(
    public dataSource: PaymentTableClaimsDataSource,
