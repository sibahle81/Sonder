...
import { UntypedFormControl, UntypedFormBuilder, UntypedFormGroup, FormControl } from '@angular/forms';
...
import { PolicyPayment } from 'projects/fincare/src/app/shared/models/PolicyPayment';
...
@Component({
  selector: 'claim-payment-overview',
  templateUrl: './claim-payment-overview.component.html',
  styleUrls: ['./claim-payment-overview.component.css']
})
export class ClaimPaymentOverviewComponent {
  ...
  getData() {
    ...
    this.paymentService.getPaymentsProductOverview(params.startDate,params.endDate,params.paymentStatusId,params.product,params.query).subscribe(results => {
      this.data = results;
