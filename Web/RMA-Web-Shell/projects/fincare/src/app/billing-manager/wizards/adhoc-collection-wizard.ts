...
export class AdhocCollectionWizard extends WizardContext {
  ...
  constructor(componentFactoryResolver: ComponentFactoryResolver) {
    ...
    this.wizardComponents.push(new WizardComponentStep(0, 'Adhoc Debit Orders', DebitOrderCollectionListComponent));
  }
