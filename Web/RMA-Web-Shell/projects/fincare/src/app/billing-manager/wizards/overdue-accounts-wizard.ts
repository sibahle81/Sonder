...
export class OverdueAccountsWizard extends WizardContext {
  ...
  constructor(componentFactoryResolver: ComponentFactoryResolver) {
    ...
    this.wizardComponents.push(new WizardComponentStep(0, 'Outstanding Invoices', CollectionAssignmentComponent));
  }
