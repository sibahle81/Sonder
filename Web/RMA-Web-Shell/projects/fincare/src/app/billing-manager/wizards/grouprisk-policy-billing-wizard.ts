...
export class GroupRiskPolicyBillingWizard extends WizardContext {
  ...
  constructor(componentFactoryResolver: ComponentFactoryResolver) {
    ...
    //this.wizardComponents.push(new WizardComponentStep(1, 'Notes', GroupriskPolicyBillingNotesComponent));
  }
