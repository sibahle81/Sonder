...
import { UploadedFileDetailsDatasource } from './uploaded-file-details.datasourse';
...
export class UploadedFileDetailsComponent implements OnInit {
  ...
  constructor(private readonly collectionService: CollectionsService,
    ...
    public datasource: UploadedFileDetailsDatasource) {
  ...
  back() {
    this.router.navigate(['fincare/billing-manager/bulk-manual-files/']);
  }
