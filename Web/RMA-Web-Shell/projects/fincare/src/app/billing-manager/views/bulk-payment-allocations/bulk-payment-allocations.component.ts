...
@Component({
  selector: 'app-bulk-payment-allocations.component',
  templateUrl: './bulk-payment-allocations.component.html',
  styleUrls: ['./bulk-payment-allocations.component.css']
})
export class BulkPaymentAllocationsComponent implements OnInit {
