...
import { WorkItemSearchDataSource } from 'projects/legalcare/src/app/work-manager/datasources/work-item-search-datasource';
...
export class WorkItemSearchComponent implements OnInit, AfterViewInit {
  ...
  constructor(private readonly router: Router, private readonly wizardService: WizardService, private readonly wizardConfigurationService: WizardConfigurationService,
                private readonly legalService: LegalCareService) { }
  ngAfterViewInit(): void {
    
  }

  ngOnInit() {
    this.dataSource = new WorkItemSearchDataSource(this.legalService);
  }
