...
@Component({
  selector: 'quote-sla-status-filter',
  templateUrl: './quote-sla-status-filter.component.html',
  styleUrls: ['./quote-sla-status-filter.component.css']
})
export class QuoteSlaStatusFilterComponent implements OnInit, OnChanges {
  ...
  getLookups() {
    this.statuses = this.ToArray(QuoteStatusEnum);
    this.createForm();
  }
