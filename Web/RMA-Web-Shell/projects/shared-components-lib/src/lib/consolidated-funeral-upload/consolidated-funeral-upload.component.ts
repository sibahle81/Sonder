...
import { PolicyOnboardOptionEnum } from 'projects/shared-models-lib/src/lib/enums/policy-onboard-option-enum';
...
@Component({
  selector: 'lib-consolidated-funeral-upload',
  templateUrl: './consolidated-funeral-upload.component.html',
  styleUrls: ['./consolidated-funeral-upload.component.css']
})
export class ConsolidatedFuneralUploadComponent  implements OnInit {
