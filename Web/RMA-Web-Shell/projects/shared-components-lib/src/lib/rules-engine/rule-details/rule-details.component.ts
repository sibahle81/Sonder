...
import { BreadcrumbRuleService } from 'projects/shared-components-lib/src/lib/rules-engine/shared/services/breadcrumb-rule.service';
...
import { RuleConfig } from 'projects/shared-components-lib/src/lib/rules-engine/shared/models/rule-config';
...
export class RuleDetailsComponent extends DetailsComponent implements OnInit, AfterViewInit, AfterContentChecked {
    ...
    checkUserEditPermission(): void {
        this.canEdit = userUtility.hasPermission('Edit Rule');
    }
